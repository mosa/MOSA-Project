 ...
 *
 * PCIDeviceSignatureAttribute.cs: Represents binding attributes and options for a PCI device driver
*/

using System;

namespace Mosa.Devices.PCI
{
    ...
    public class PCIDeviceSignatureAttribute : System.Attribute
    {
        ...
        public int Priority
        {
            get
            {
                //Ensemble will use the following PCI binding order:
