...
namespace Mosa.Kernel.Memory
{
	...
	public interface IVirtualPageManager
	{
		...
		IntPtr Allocate(ulong pages, PageProtectionFlags protectionFlags);
		...
		void Free(IntPtr address, ulong pages);
		...
		PageProtectionFlags Protect(IntPtr address, ulong pages, PageProtectionFlags protectionFlags);
