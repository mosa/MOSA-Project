...
namespace Mosa.Platforms.x86.Instructions
{
    ...
    /// </summary>
    class DirectDivisionInstruction : IR.OneOperandInstruction
    {
        #region Construction
        ...
        public DirectDivisionInstruction(Operand source) :
            base(source)
        {
        }
        ...
        {
            return String.Format(@"x86 idiv {0} ; edx:eax /= {0}", this.Operand0);
        }
