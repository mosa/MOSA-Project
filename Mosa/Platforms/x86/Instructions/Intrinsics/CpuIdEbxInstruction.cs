...
namespace Mosa.Platforms.x86.Instructions.Intrinsics
{
    ...
    /// </summary>
    public sealed class CpuIdEbxInstruction : IR.TwoOperandInstruction
    {
        #region Construction
        ...
        public CpuIdEbxInstruction(Operand destination, Operand source) :
