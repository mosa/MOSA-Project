...
namespace Mosa.Platforms.x86.Instructions
{
    ...
    /// </summary>
    class RcrInstruction : IR.TwoOperandInstruction
    {
        #region Construction
        ...
        public RcrInstruction(Operand destination, Operand source) :
        ...
        {
            return String.Format(@"x86 rcr {0}, {1} ;  {0} >>= {1}", this.Operand0, this.Operand1);
        }
