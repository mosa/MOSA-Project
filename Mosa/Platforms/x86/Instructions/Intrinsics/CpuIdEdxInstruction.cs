...
namespace Mosa.Platforms.x86.Instructions.Intrinsics
{
    ...
    /// </summary>
    public sealed class CpuIdEdxInstruction : IR.TwoOperandInstruction
    {
        #region Construction

        /// <summary>
        /// Initializes a new instance of the <see cref="CpuIdEdxInstruction"/> class.
        /// </summary>
        public CpuIdEdxInstruction() :
            base()
        {
        }
        ...
        public CpuIdEdxInstruction(Operand destination, Operand source) :
