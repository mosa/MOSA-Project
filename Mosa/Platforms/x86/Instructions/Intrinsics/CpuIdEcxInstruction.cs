...
namespace Mosa.Platforms.x86.Instructions.Intrinsics
{
    ...
    /// </summary>
    public sealed class CpuIdEcxInstruction : IR.TwoOperandInstruction
    {
        #region Construction
        ...
        public CpuIdEcxInstruction(Operand destination, Operand source) :
