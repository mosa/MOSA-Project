...
#pragma warning disable 1591
        ...
        public static class X86Instruction
        {
            ...
            public static class Cmp
            {
                ...
                public static OpCode R_C_8 = new OpCode(new byte[] { 0x80 }, 7);
            ...
            public static class Sar
            {
                ...
                public static OpCode R_CL = new OpCode(new byte[] { 0xD3 }, 7);
            }
            public static class Sal
            {
                ...
                public static OpCode R_C = new OpCode(new byte[] { 0xC1 }, 4);
                public static OpCode M_C = new OpCode(new byte[] { 0xC1 }, 4);
                public static OpCode R_CL = new OpCode(new byte[] { 0xD3 }, 4);
            }
...
#pragma warning restore 1591
        ...
        /// <param name="src">The SRC.</param>
        /// <returns></returns>
        public static OpCode Sal(Operand dest, Operand src)
        {
            if ((dest is RegisterOperand) && (src is ConstantOperand)) return X86Instruction.Sal.R_C;
            if ((dest is MemoryOperand) && (src is ConstantOperand)) return X86Instruction.Sal.M_C;
            if (dest is RegisterOperand) return X86Instruction.Sal.R;
            if (dest is MemoryOperand) return X86Instruction.Sal.M;
            throw new ArgumentException(@"No opcode for operand type.");
        }
