...
namespace Mosa.Platforms.x86.Instructions.Intrinsics
{
    ...
    /// </summary>
    public sealed class CpuIdEaxInstruction : IR.TwoOperandInstruction
    {
        #region Construction

        /// <summary>
        /// Initializes a new instance of the <see cref="CpuIdEaxInstruction"/> class.
        /// </summary>
        public CpuIdEaxInstruction() :
            base()
        {
        }
        ...
        public CpuIdEaxInstruction(Operand destination, Operand source) :
