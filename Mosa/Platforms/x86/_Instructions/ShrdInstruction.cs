...
namespace Mosa.Platforms.x86.Instructions
{
    ...
    /// </summary>
    public class ShrdInstruction : IR.ThreeOperandInstruction
    {
        #region Construction
        ...
        public ShrdInstruction(Operand dst, Operand src, Operand count) :
            base(dst, src, count)
        {
        }
        ...
        {
            return String.Format(@"x86 shrd {0}, {1}, {2}", this.Operand0, this.Operand1, this.Operand2);
        }
