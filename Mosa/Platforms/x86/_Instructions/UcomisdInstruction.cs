...
namespace Mosa.Platforms.x86.Instructions
{
    ...
    /// </summary>
    public class UcomisdInstruction : IR.TwoOperandInstruction
    {
        #region Construction
        ...
        public UcomisdInstruction(Operand result, Operand op1) :
            base(result, op1)
        {
        }
        ...
        {
            return String.Format("x86 ucomisd {0}, {1} ; {0} == {1}", this.Operand0, this.Operand1);
        }
