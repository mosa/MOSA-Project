...
namespace Mosa.Platforms.x86.Instructions
{
    ...
    /// </summary>
    class SalInstruction : IR.TwoOperandInstruction
    {
        #region Construction
        ...
        public SalInstruction(Operand destination, Operand source) :
        ...
        {
            return String.Format(@"x86 Sal {0}, {1} ;  {0} >>= {1}", this.Operand0, this.Operand1);
        }
