...
namespace Mosa.Platforms.x86.Instructions
{
    ...
    /// </summary>
    public class UcomissInstruction : IR.TwoOperandInstruction
    {
        #region Construction
        ...
        public UcomissInstruction(Operand result, Operand op1) :
            base(result, op1)
        {
        }
        ...
        {
            return String.Format("x86 ucomiss {0}, {1} ; {0} == {1}", this.Operand0, this.Operand1);
        }
