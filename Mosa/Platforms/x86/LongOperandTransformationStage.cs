...
namespace Mosa.Platforms.x86
{
    ...
    public sealed class LongOperandTransformationStage : CodeTransformationStage, CIL.ICILVisitor, IR.IIRVisitor, IPlatformTransformationStage, IPipelineStage
    {
        ...
        private void ExpandMul(Context ctx)
        {
            ...
            newBlocks[0].AppendInstruction(CPUx86.Instruction.MulInstruction, null, ecx);
            newBlocks[0].AppendInstruction(CPUx86.Instruction.JmpInstruction, newBlocks[2].BasicBlock);
            LinkBlocks(newBlocks[0], newBlocks[2]);

            newBlocks[1].AppendInstruction(CPUx86.Instruction.PushInstruction, null, ebx);
            ...
            newBlocks[1].AppendInstruction(CPUx86.Instruction.MulInstruction, null, op2H);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.AddInstruction, ebx, eax);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.MovInstruction, eax, op1L);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.MulInstruction, null, ecx);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.AddInstruction, edx, ebx);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.PopInstruction, ebx);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.JmpInstruction, newBlocks[2].BasicBlock);
            LinkBlocks(newBlocks[1], newBlocks[2]);

            newBlocks[2].AppendInstruction(CPUx86.Instruction.MovInstruction, op0L, eax);
            newBlocks[2].AppendInstruction(CPUx86.Instruction.MovInstruction, op0H, edx);
        ...
        private void ExpandRem(Context ctx)
        {
            ...
            newBlocks[5].AppendInstruction(CPUx86.Instruction.MovInstruction, eax, op1H);
            newBlocks[5].AppendInstruction(CPUx86.Instruction.XorInstruction, edx, edx);
            newBlocks[5].AppendInstruction(CPUx86.Instruction.DirectDivisionInstruction, ecx);
            ...
            newBlocks[8].AppendInstruction(CPUx86.Instruction.DirectDivisionInstruction, ecx);
            newBlocks[8].AppendInstruction(CPUx86.Instruction.MovInstruction, ecx, eax);
            newBlocks[8].AppendInstruction(CPUx86.Instruction.MulInstruction, null, op2H);
        ...
        private void ExpandURem(Context ctx)
        {
            ...
            newBlocks[1].AppendInstruction(CPUx86.Instruction.MovInstruction, eax, op1H);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.XorInstruction, edx, edx);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.DirectDivisionInstruction, ecx);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.MovInstruction, eax, op1L);
            newBlocks[1].AppendInstruction(CPUx86.Instruction.DirectDivisionInstruction, ecx);
            ...
            newBlocks[4].AppendInstruction(CPUx86.Instruction.DirectDivisionInstruction, ebx);
            newBlocks[4].AppendInstruction(CPUx86.Instruction.MovInstruction, ecx, eax);
            newBlocks[4].AppendInstruction(CPUx86.Instruction.MulInstruction, null, op2H);
        ...
        private void ExpandUnaryBranch(Context ctx)
        {
            ...
            LinkBlocks(ctx, FindBlock(targets[0]));
            LinkBlocks(ctx, FindBlock(targets[1]));
        }
