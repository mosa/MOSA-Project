...
namespace Mosa.Platforms.x86
{
		...
		IR.IIRVisitor
	{
		...
		private void ExpandMul(Context ctx)
		{
			...
			newBlocks[2].InsertInstructionAfter(IR.Instruction.PopInstruction, ebx);
			newBlocks[2].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
		...
		private void ExpandDiv(Context ctx)
		{
			...
			newBlocks[1].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[2].BasicBlock);
			...
			newBlocks[2].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[3].BasicBlock);
			...
			newBlocks[4].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[5].BasicBlock);
			...
			newBlocks[5].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[14].BasicBlock);
			...
			newBlocks[6].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[7].BasicBlock);
			...
			newBlocks[8].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[9].BasicBlock);
			...
			newBlocks[9].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[10].BasicBlock);
			...
			newBlocks[10].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[11].BasicBlock);
			...
			newBlocks[11].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[12].BasicBlock);

			// L6:
			newBlocks[12].InsertInstructionAfter(CPUx86.Instruction.DecInstruction, esi);
			newBlocks[12].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[13].BasicBlock);
			...
			newBlocks[13].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[14].BasicBlock);
			...
			newBlocks[14].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[15].BasicBlock);
			...
			newBlocks[15].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
			...
			nextBlock.InsertInstructionAfter(IR.Instruction.PopInstruction, ebx);
			nextBlock.InsertInstructionAfter(IR.Instruction.PopInstruction, esi);
			nextBlock.InsertInstructionAfter(IR.Instruction.PopInstruction, edi);
		...
		private void ExpandRem(Context ctx)
		{
			...
			newBlocks[5].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
			...
			newBlocks[14].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
			...
			ctx.InsertInstructionAfter(IR.Instruction.PopInstruction, ebx);
			ctx.InsertInstructionAfter(IR.Instruction.PopInstruction, esi);
		...
		private void ExpandUDiv(Context ctx)
		{
			...
			newBlocks[5].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[6].BasicBlock);
			...
			newBlocks[9].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
		...
		private void ExpandURem(Context ctx)
		{
			...
			newBlocks[7].InsertInstructionAfter(CPUx86.Instruction.CmpInstruction, eax, op1L);
			newBlocks[7].InsertInstructionAfter(IR.Instruction.BranchInstruction, IR.ConditionCode.UnsignedLessOrEqual, newBlocks[9].BasicBlock);
			newBlocks[7].InsertInstructionAfter(IR.Instruction.JmpInstruction, newBlocks[3].BasicBlock);
		...
		private void ExpandArithmeticShiftRight(Context ctx)
		{
			...
			newBlocks[3].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
			...
			newBlocks[4].InsertInstructionAfter(IR.Instruction.JmpInstruction, nextBlock.BasicBlock);
		...
		private void ExpandUnaryBranch(Context ctx)
		{
			...
			newBlocks[1].InsertInstructionAfter(IR.Instruction.JmpInstruction);
