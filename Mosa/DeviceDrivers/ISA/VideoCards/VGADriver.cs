...
namespace Mosa.DeviceDrivers.ISA.VideoCards
{
	...
	/// VGA Device Driver
	/// </summary>
	[ISADeviceSignature(AutoLoad = false, BasePort = 0x03B0, PortRange = 0x1F, BaseAddress = 0xA0000, AddressRange = 0x20000, Platforms = PlatformArchitecture.Both_x86_and_x64)]
	public class VGADriver : ISAHardwareDevice, IDevice, IPixelPaletteGraphicsDevice
	{
		#region Definitions
		...
		public override bool Setup()
		{
			...
			miscellaneousOutputRead = base.busResources.GetIOPort(0, (byte)(0x3CC - 0x3B0));
			...
			dacPaletteMask = base.busResources.GetIOPort(0, (byte)(0x3C6 - 0x3B0));
			dacIndexRead = base.busResources.GetIOPort(0, (byte)(0x3C7 - 0x3B0));
			dacIndexWrite = base.busResources.GetIOPort(0, (byte)(0x3C8 - 0x3B0));
			dacData = base.busResources.GetIOPort(0, (byte)(0x3C9 - 0x3B0));

			inputStatus1 = base.busResources.GetIOPort(0, (byte)(0x3C2 - 0x3B0));
			miscellaneousOutputWrite = base.busResources.GetIOPort(0, (byte)(0x3C2 - 0x3B0));
			sequencerAddress = base.busResources.GetIOPort(0, (byte)(0x3C4 - 0x3B0));
			sequencerData = base.busResources.GetIOPort(0, (byte)(0x3C5 - 0x3B0));

			graphicsControllerAddress = base.busResources.GetIOPort(0, (byte)(0x3CE - 0x3B0));
			graphicsControllerData = base.busResources.GetIOPort(0, (byte)(0x3CF - 0x3B0));

			inputStatus1ReadB = base.busResources.GetIOPort(0, (byte)(0x3DA - 0x3B0));

			attributeAddress = base.busResources.GetIOPort(0, (byte)(0x3C0 - 0x3B0));
			attributeData = base.busResources.GetIOPort(0, (byte)(0x3C1 - 0x3B0));
