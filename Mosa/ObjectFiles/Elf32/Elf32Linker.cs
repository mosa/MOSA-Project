...
namespace Mosa.ObjectFiles.Elf32
{
    ...
    public class Elf32Linker : Mosa.Runtime.Linker.AssemblyLinkerStageBase
    {
        ...
        /// <returns></returns>
        public override long Link(Mosa.Runtime.Linker.LinkType linkType, Mosa.Runtime.Vm.RuntimeMethod method, int methodOffset, int methodRelativeBase, Mosa.Runtime.Vm.RuntimeMember target)
        {
        ...
        /// </returns>
        public override long Link(Mosa.Runtime.Linker.LinkType linkType, Mosa.Runtime.Vm.RuntimeMethod method, int methodOffset, int methodRelativeBase, string symbol)
        {
        ...
        protected override void ApplyPatch(Mosa.Runtime.Linker.LinkType linkType, Mosa.Runtime.Vm.RuntimeMethod method, long methodOffset, long methodRelativeBase, long targetAddress)
        {
            throw new NotImplementedException();
        }
