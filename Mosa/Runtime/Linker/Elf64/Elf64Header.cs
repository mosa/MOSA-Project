...
namespace Mosa.Runtime.Linker.Elf64
{
    ...
    public class Elf64Header
    {
        ...
        /// </summary>
        public Elf64FileType Type;
        /// <summary>
        /// This member's value specifies the required architecture for an individual file.
        /// </summary>
        public Elf64MachineType Machine;
        /// <summary>
        /// This member identifies the object file version. 
        /// </summary>
        public Elf64Version Version;
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Elf64Header"/> class.
        /// </summary>
        public Elf64Header()
        {
            ElfHeaderSize = 0x34;
        ...
        public void Read(System.IO.BinaryReader reader)
        {
            ...
            Type = (Elf64FileType)reader.ReadUInt16();
            Machine = (Elf64MachineType)reader.ReadUInt16();
            Version = (Elf64Version)reader.ReadUInt32();
        ...
        public void CreateIdent(Elf64IdentClass identClass, Elf64IdentData data, byte[] padding)
        {
            // Store magic number
            ...
            Ident[6] = (byte)Elf64Version.Current;
            Version = Elf64Version.Current;
        ...
        public void PrintInfo()
        {
            ...
            Console.WriteLine("Ident class:                    {0} ({1})", ((Elf64IdentClass)Ident[4]).ToString(), ((Elf64IdentClass)Ident[4]).ToString("x"));
            Console.WriteLine("Ident data:                     {0} ({1})", ((Elf64IdentData)Ident[4]).ToString(), ((Elf64IdentData)Ident[4]).ToString("x"));
