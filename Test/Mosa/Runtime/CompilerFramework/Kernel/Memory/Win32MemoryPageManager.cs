...
namespace Test.Mosa.Runtime.CompilerFramework.Kernel.Memory
{
    /// <summary>
    /// Provides implementation of <see cref="Mosa.Kernel.Memory.IMemoryPageManager"/> based on Win32 virtual memory.
    /// </summary>
