...
namespace Test.Mosa.Runtime.CompilerFramework.IL
{
    ...
    /// </summary>
    [TestFixture]
    public class Clt : MosaCompilerTestRunner
    {
        ...
        [Row(false, 0, 0)]
        [Row(false, 1, 1)]
        [Row(true, Int16.MinValue, Int16.MinValue + 10)]
        [Row(false, Int16.MaxValue, Int16.MaxValue)]
        [Row(false, 0, Int16.MinValue)]
        [Row(true, 0, Int16.MaxValue)]
        [Row(true, 0, 1)]
        [Row(true, Int16.MinValue, 0)]
        [Row(false, Int16.MaxValue, 0)]
        [Row(false, 1, 0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltI2(bool result, short a, short b)
        {
        ...
        [Row(false, 0, 0)]
        [Row(false, 1, 1)]
        [Row(true, Int32.MinValue, Int32.MinValue  + 10)]
        [Row(false, Int32.MaxValue, Int32.MaxValue)]
        [Row(false, 0, Int32.MinValue)]
        [Row(true, 0, Int32.MaxValue)]
        [Row(true, 0, 1)]
        [Row(true, Int32.MinValue, 0)]
        [Row(false, Int32.MaxValue, 0)]
        [Row(false, 1, 0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltI4(bool result, int a, int b)
        {
        ...
        [Row(true, 0L, Int64.MaxValue)]
        [Row(true, 0L, 1L)]
        [Row(true, Int64.MinValue, 0L)]
        [Row(false, Int64.MaxValue, 0L)]
        [Row(false, 1L, 0L)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltI8(bool result, long a, long b)
        {
        ...
        [Row(false, 0, 0)]
        [Row(false, 1, 1)]
        [Row(true, Byte.MinValue, Byte.MinValue + 10)]
        [Row(false, Byte.MaxValue, Byte.MaxValue)]
        [Row(false, 1, Byte.MinValue)]
        [Row(true, 0, Byte.MaxValue)]
        [Row(true, 0, 1)]
        [Row(true, Byte.MinValue, 1)]
        [Row(false, Byte.MaxValue, 0)]
        [Row(false, 1, 0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltU1(bool result, byte a, byte b)
        {
        ...
        [Row(false, 0, 0)]
        [Row(false, 1, 1)]
        [Row(true, UInt16.MinValue, UInt16.MinValue + 10)]
        [Row(false, UInt16.MaxValue, UInt16.MaxValue)]
        [Row(false, 1, UInt16.MinValue)]
        [Row(true, 0, UInt16.MaxValue)]
        [Row(true, 0, 1)]
        [Row(true, UInt16.MinValue, 2)]
        [Row(false, UInt16.MaxValue, 0)]
        [Row(false, 1, 0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltU2(bool result, ushort a, ushort b)
        {
        ...
        [Row(false, 0, 0)]
        [Row(false, 1, 1)]
        [Row(true, UInt32.MinValue, UInt32.MinValue + 10)]
        [Row(false, UInt32.MaxValue, UInt32.MaxValue)]
        [Row(false, 1, UInt32.MinValue)]
        [Row(true, 0, UInt32.MaxValue)]
        [Row(true, 0, 1)]
        [Row(true, UInt32.MinValue, 1)]
        [Row(false, UInt32.MaxValue, 0)]
        [Row(false, 1, 0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltU4(bool result, uint a, uint b)
        {
        ...
        [Row(false, 0, 0)]
        [Row(false, 1, 1)]
        [Row(true, UInt64.MinValue, UInt64.MinValue + 10)]
        [Row(false, UInt64.MaxValue, UInt64.MaxValue)]
        [Row(false, 1, UInt64.MinValue)]
        [Row(true, 0, UInt64.MaxValue)]
        [Row(true, 0, 1)]
        [Row(true, UInt64.MinValue, 1)]
        [Row(false, UInt64.MaxValue, 0)]
        [Row(false, 1, 0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltU8(bool result, ulong a, ulong b)
        {
        ...
        [Row(false, 0.0f, 0.0f)]
        [Row(false, 1.0f, 1.0f)]
        [Row(true, Single.MinValue, Single.MinValue + 10)]
        [Row(false, Single.MaxValue, Single.MaxValue)]
        [Row(false, 0.0f, Single.MinValue)]
        [Row(true, 0.0f, Single.MaxValue)]
        [Row(true, 0.0f, 1.0f)]
        [Row(true, Single.MinValue, 0.0f)]
        [Row(false, Single.MaxValue, 0.0f)]
        [Row(false, 1.0f, 0.0f)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltR4(bool result, float a, float b)
        {
        ...
        [Row(true, 0.0, 0.5)]
        [Row(true, 1.0, 2.0)]
        [Row(true, Double.MinValue, Double.MinValue + 1)]
        [Row(true, Double.MaxValue - 1, Double.MaxValue)]
        [Row(false, 0.0, Double.MinValue)]
        [Row(true, 0.0, Double.MaxValue)]
        [Row(true, 0.0, 1.0)]
        [Row(true, Double.MinValue, 0.0)]
        [Row(false, Double.MaxValue, 0.0)]
        [Row(false, 1.0, 0.0)]
        [Test, Author(@"Michael Ruck"), Importance(Importance.Critical)]
        public void CltR8(bool result, double a, double b)
        {
