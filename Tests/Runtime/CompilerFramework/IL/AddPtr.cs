...
namespace Test.Mosa.Runtime.CompilerFramework.IL
{
	...
	public class AddPtr : CodeDomTestRunner
	{
		...
		public unsafe void AddI4PtrI8Right(int a, int b)
		{
			...
			UnsafeCode = true;
			Assert.AreEqual((int)(b + pa), (int)Run<IntPtr>("", "Test", "AddPtr", b, a));
		}
		...
		public unsafe void AddConstantI4PtrI4Left(int a, int b)
		{
			...
			UnsafeCode = true;
			Assert.AreEqual((int)(pa + b), (int)Run<IntPtr>("", "Test", "AddPtr", a));
		}
		...
		public unsafe void AddConstantI4PtrI4Right(int a, int b)
		{
			...
			UnsafeCode = true;
			Assert.AreEqual((int)(b + pa), (int)Run<IntPtr>("", "Test", "AddPtr", a));
		}
		...
		public unsafe void AddI8PtrI4Left(int a, int b)
		{
			...
			UnsafeCode = true;
			Assert.AreEqual((int)(pa + b), (int)Run<IntPtr>("", "Test", "AddPtr", a, b));
		}
