...
namespace Mosa.Tools.Permutations
{
	public static class I4
	{
		...
		public static IList<string> GetAllPermutations()
		{
			...
			//list.AddIfNew(Power2.GetPowerTwos(0, (ulong)int.MaxValue));

			// a few prime numbers
			//list.AddIfNew(Prime.GetSomePrimes(0, (ulong)int.MaxValue));

			// Get negatives
			list.AddIfNew(Negative.GetNegatives(int.MinValue, list));
