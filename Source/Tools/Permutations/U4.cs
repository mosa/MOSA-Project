...
namespace Mosa.Tools.Permutations
{
	...
	{
		public static string Type = "uint";
		...
		public static IList<string> GetAllPermutations()
		{
			...
			//list.AddIfNew(Power2.GetPowerTwos(uint.MinValue, uint.MaxValue));

			// a few prime numbers
			//list.AddIfNew(Prime.GetSomePrimes(uint.MinValue, uint.MaxValue));
