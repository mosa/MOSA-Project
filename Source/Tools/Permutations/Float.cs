...
namespace Mosa.Tools.Permutations
{
	public static class Float
	{
		...
		public static IList<string> GetAllPermutations()
		{
			...
			list.AddIfNew(float.MinValue.ToString());
			list.AddIfNew(float.MaxValue.ToString());
			list.AddIfNew("float.NaN");
			list.AddIfNew("float.PositiveInfinity");
			list.AddIfNew("float.NegativeInfinity");
