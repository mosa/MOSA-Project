...
namespace Mosa.UnitTest.Collection.xUnit
{
	public class Int8Fixture : TestFixture
	{
		...
		{
			Assert.Equal(Int8Tests.SubI1I1(a, b), Run<int>("Mosa.UnitTest.Collection.Int8Tests.SubI1I1", a, b));
		}
		...
		{
			Assert.Equal(Int8Tests.MulI1I1(a, b), Run<int>("Mosa.UnitTest.Collection.Int8Tests.MulI1I1", a, b));
		}
		...
		{
			Assert.Equal(Int8Tests.AndI1I1(a, b), Run<int>("Mosa.UnitTest.Collection.Int8Tests.AndI1I1", a, b));
		}
		...
		{
			Assert.Equal(Int8Tests.OrI1I1(a, b), Run<int>("Mosa.UnitTest.Collection.Int8Tests.OrI1I1", a, b));
		}
		...
		[Theory]
		[MemberData(nameof(I1U1UpTo16), DisableDiscoveryEnumeration = true)]
		public void ShiftLeftI1I1(sbyte a, byte b)
		{
			Assert.Equal(Int8Tests.ShiftLeftI1I1(a, b), Run<int>("Mosa.UnitTest.Collection.Int8Tests.ShiftLeftI1I1", a, b));
		}
		...
		{
			Assert.Equal(Int8Tests.CltI1I1(a, b), Run<bool>("Mosa.UnitTest.Collection.Int8Tests.CltI1I1", a, b));
		}
		...
		{
			Assert.Equal(Int8Tests.CgtI1I1(a, b), Run<bool>("Mosa.UnitTest.Collection.Int8Tests.CgtI1I1", a, b));
		}
		...
		{
			Assert.Equal(Int8Tests.CleI1I1(a, b), Run<bool>("Mosa.UnitTest.Collection.Int8Tests.CleI1I1", a, b));
		}
		...
		public void Newarr()
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection.Int8Tests.Newarr"));
		}
		...
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection.Int8Tests.Ldlen", length));
		}

		[Theory]
		[MemberData(nameof(I4SmallI1), DisableDiscoveryEnumeration = true)]
		public void StelemI1(int index, sbyte value)
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection.Int8Tests.Stelem", index, value));
		}
		...
		{
			Assert.Equal(Int8Tests.Ldelem(index, value), Run<sbyte>("Mosa.UnitTest.Collection.Int8Tests.Ldelem", index, value));
		}
