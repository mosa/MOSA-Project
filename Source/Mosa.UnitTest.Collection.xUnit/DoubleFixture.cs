...
namespace Mosa.UnitTest.Collection.xUnit
{
	public class DoubleFixture : TestFixture
	{
		...
		[Theory]
		[MemberData(nameof(R8R8), DisableDiscoveryEnumeration = true)]
		...
		[Theory]
		[MemberData(nameof(R8SimpleR8Simple), DisableDiscoveryEnumeration = true)]
		...
		[Theory]
		[MemberData(nameof(I4SmallR8Simple), DisableDiscoveryEnumeration = true)]
		...
		{
			Assert.Equal(DoubleTests.Ldelem(index, value), Run<bool>("Mosa.UnitTest.Collection.DoubleTests.Ldelem", index, value));
		}
