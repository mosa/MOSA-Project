...
namespace Mosa.UnitTest.Collection.xUnit
{
	public class SingleFixture : TestFixture
	{
		...
		public void Newarr()
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection", "SingleTests", "Newarr"));
		}
		...
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection", "SingleTests", "Ldlen", length));
		}
		...
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection", "SingleTests", "Stelem", index, value));
		}
		...
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection", "SingleTests", "Ldelem", index, value));
		}
		...
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection", "SingleTests", "Ldelema", index, value));
		}
