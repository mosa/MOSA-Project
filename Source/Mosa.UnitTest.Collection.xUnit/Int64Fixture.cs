...
namespace Mosa.UnitTest.Collection.xUnit
{
	public class Int64Fixture : TestFixture
	{
		...
		{
			Assert.Equal(Int64Tests.SubI8I8(a, b), Run<long>("Mosa.UnitTest.Collection.Int64Tests.SubI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.MulI8I8(a, b), Run<long>("Mosa.UnitTest.Collection.Int64Tests.MulI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.AndI8I8(a, b), Run<long>("Mosa.UnitTest.Collection.Int64Tests.AndI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.XorI8I8(a, b), Run<long>("Mosa.UnitTest.Collection.Int64Tests.XorI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.CompI8(a), Run<long>("Mosa.UnitTest.Collection.Int64Tests.CompI8", a));
		}

		[Theory]
		[MemberData(nameof(I8U1UpTo32), DisableDiscoveryEnumeration = true)]
		public void ShiftLeftI8I8(long a, byte b)
		{
			Assert.Equal(Int64Tests.ShiftLeftI8U1(a, b), Run<long>("Mosa.UnitTest.Collection.Int64Tests.ShiftLeftI8U1", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.CeqI8I8(a, b), Run<bool>("Mosa.UnitTest.Collection.Int64Tests.CeqI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.CltI8I8(a, b), Run<bool>("Mosa.UnitTest.Collection.Int64Tests.CltI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.CgtI8I8(a, b), Run<bool>("Mosa.UnitTest.Collection.Int64Tests.CgtI8I8", a, b));
		}
		...
		{
			Assert.Equal(Int64Tests.CleI8I8(a, b), Run<bool>("Mosa.UnitTest.Collection.Int64Tests.CleI8I8", a, b));
		}
		...
		public void Newarr()
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection.Int64Tests.Newarr"));
		}
		...
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection.Int64Tests.Ldlen", length));
		}

		[Theory]
		[MemberData(nameof(I4SmallI8), DisableDiscoveryEnumeration = true)]
		public void StelemI8(int index, long value)
		{
			Assert.True(Run<bool>("Mosa.UnitTest.Collection.Int64Tests.Stelem", index, value));
		}
		...
		{
			Assert.Equal(Int64Tests.Ldelem(index, value), Run<long>("Mosa.UnitTest.Collection.Int64Tests.Ldelem", index, value));
		}
