...
using Mosa.Compiler.Framework.CLR.CIL;
using Mosa.Compiler.Framework.Linker;
using Mosa.Compiler.MosaTypeSystem;

namespace Mosa.Compiler.Framework.CLR.Stages;
...
/// </remarks>
internal sealed class CILTransformationStage : BaseCodeTransformationStageLegacy
{
	...
	private IntrinsicMethodDelegate ResolveIntrinsicDelegateMethod(MosaMethod method)
	{
		...
		else
		{
			...
			intrinsic = MethodCompiler.Compiler.GetIntrinsicMethod(methodName);
		}
