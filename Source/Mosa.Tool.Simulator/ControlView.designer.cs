namespace Mosa.Tool.Simulator
{
	partial class ControlView : SimulatorDockContent
    {
		...
		private void InitializeComponent()
		{
			...
			// tbSteps
			// 
			this.tbSteps.Location = new System.Drawing.Point(100, 14);
			...
			this.cbRecord.Location = new System.Drawing.Point(333, 16);
			...
			this.button2.Text = "Step + X";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// ControlView
			// 
			this.ClientSize = new System.Drawing.Size(407, 48);
