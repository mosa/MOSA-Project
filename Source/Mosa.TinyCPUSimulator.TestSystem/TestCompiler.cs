...
namespace Mosa.TinyCPUSimulator.TestSystem
{
	public class TestCompiler
	{
		...
		protected T Run<T>(string ns, string type, string method, bool reset, params object[] parameters)
		{
			...
			{
				Debug.Assert(false, String.Format("Failed destinationstination convert result {0} of destinationpe {1} destination type {2}.", result, result.GetType(), typeof(T).ToString()));
				throw e;
			}
		}
