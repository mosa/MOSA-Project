...
namespace Mosa.Runtime.x64
{
	...
	public static unsafe class Native
	{
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Lidt")]
		public static extern void Lidt(ulong address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Cli")]
		public static extern void Cli();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Lgdt")]
		public static extern void Lgdt(ulong address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Sti")]
		public static extern void Sti();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::In8")]
		public static extern byte In8(ushort address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::In16")]
		public static extern ushort In16(ushort address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::In32")]
		public static extern uint In32(ushort address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Out8")]
		public static extern void Out8(ushort address, byte value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Out16")]
		public static extern void Out16(ushort address, ushort value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Out32")]
		public static extern void Out32(ushort address, uint value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Nop")]
		public static extern void Nop();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Hlt")]
		public static extern void Hlt();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Invlpg")]
		public static extern void Invlpg(ulong address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::CpuIdRAX")]
		public static extern ulong CpuIdRAX(ulong eax, ulong rcx);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::CpuIdRBX")]
		public static extern ulong CpuIdRBX(ulong eax, ulong rcx);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::CpuIdRCX")]
		public static extern ulong CpuIdRCX(ulong eax, ulong rcx);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::CpuIdRDX")]
		public static extern ulong CpuIdRDX(ulong eax, ulong rcx);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Pause")]
		public static extern void Pause();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Int")]
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Blsr64")]
		public static extern uint Blsr64(uint esp);

		//[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Popcnt32")]
		//public static extern uint Popcnt32(uint esp);

		//[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Popcnt64")]
		//public static extern uint Popcnt64(uint esp);

		//[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Lzcnt32")]
		//public static extern uint Lzcnt32(uint esp);

		//[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Lzcnt64")]
		...
		//[DllImport("Mosa.Compiler.Platform.x86.Intrinsic::Tzcnt64")]
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::BochsDebug")]
		public static extern void BochsDebug();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::SetCR0")]
		public static extern void SetCR0(ulong status);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::SetCR2")]
		public static extern void SetCR2(ulong status);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::SetCR3")]
		public static extern void SetCR3(ulong status);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::SetCR4")]
		public static extern void SetCR4(ulong status);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetCR0")]
		public static extern uint GetCR0();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetCR2")]
		public static extern uint GetCR2();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetCR3")]
		public static extern uint GetCR3();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetCR4")]
		public static extern uint GetCR4();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Get8")]
		public static extern byte Get8(ulong address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Get16")]
		public static extern ushort Get16(ulong address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Get32")]
		public static extern uint Get32(ulong address);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Set8")]
		public static extern void Set8(ulong address, byte value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Set16")]
		public static extern void Set16(ulong address, ushort value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Set32")]
		public static extern void Set32(ulong address, uint value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetFS")]
		public static extern ulong GetFS();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetCS")]
		public static extern ulong GetCS();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::SetFS")]
		public static extern void SetFS(ulong value);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Div")]
		public static extern uint Div(ulong n, uint d);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::CmpXChgLoad64")]
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::XAddLoad64")]
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::XChgLoad64")]
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetIDTJumpLocation")]
		public static extern long GetIDTJumpLocation(uint irq);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetMultibootRAX")]
		public static extern ulong GetMultibootRAX();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::GetMultibootRBX")]
		public static extern ulong GetMultibootRBX();

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::FrameJump")]
		public static extern void FrameJump(Pointer eip, Pointer esp, Pointer ebp, int exceptionRegister);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::FrameCall")]
		public static extern void FrameCall(ulong eip);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::FrameCallRetU8")]
		public static extern ulong FrameCallRetU8(ulong eip);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::FrameCallRetR8")]
		public static extern ulong FrameCallRetR8(ulong eip);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::InterruptReturn")]
		public static extern void InterruptReturn(ulong esp);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::AllocateStackSpace")]
		public static extern uint AllocateStackSpace(ulong size);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Remainder")]
		...
		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Memcpy256")]
		public static extern void Memcpy256(void* destination, void* source);

		[DllImport("Mosa.Compiler.Platform.x64.Intrinsic::Memclr256")]
