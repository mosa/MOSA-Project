...
namespace Mosa.Platform.x86.Stages
{
	...
	public sealed class ConstantInstructionStage : BaseTransformationStage
	{
		...
		public void Shld32(Context context)
		{
			...
			{
				context.SetInstruction(X86.ShldConst32, context.Result, context.Operand1, context.Operand2, context.Operand3);
			}
		}
		...
		public void Shrd32(Context context)
		{
			if (context.Operand3.IsConstant)
			{
				context.SetInstruction(X86.ShrdConst32, context.Result, context.Operand1, context.Operand2, context.Operand3);
			}
		}
