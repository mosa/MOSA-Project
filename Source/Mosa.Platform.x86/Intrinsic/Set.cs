...
namespace Mosa.Platform.x86.Intrinsic
{
	...
	public sealed class Set : IIntrinsicMethod
	{
		...
		void IIntrinsicMethod.ReplaceIntrinsicCall(Context context, ITypeSystem typeSystem, IList<RuntimeParameter> parameters)
		{
			...
			context.SetInstruction(OpCodes.Instruction.MovInstruction, edx, dest);
			context.AppendInstruction(OpCodes.Instruction.MovInstruction, eax, value);
			context.AppendInstruction(OpCodes.Instruction.MovInstruction, memory, eax);
		}
