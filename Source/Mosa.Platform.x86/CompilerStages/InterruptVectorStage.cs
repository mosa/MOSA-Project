	...
	public sealed class InterruptVectorStage : BaseCompilerStage
	{
		...
		private void CreateInterruptVectors()
		{
			...
			for (int i = 0; i <= 255; i++)
			{
				...
				{
					ctx.AppendInstruction(X86.Push32, null, CreateConstant(0));
				}
				ctx.AppendInstruction(X86.Push32, null, CreateConstant(i));
				...
				ctx.AppendInstruction(X86.Add32, esp, esp, CreateConstant(8));
