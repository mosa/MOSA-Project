...
namespace Mosa.Platform.x86.Transforms.IR
{
	...
	/// StoreParamR8
	/// </summary>
	public sealed class StoreParamR8 : BaseTransformation
	{
		public StoreParamR8() : base(IRInstruction.StoreParamR8, TransformationType.Manual | TransformationType.Transform)
		{
		}
