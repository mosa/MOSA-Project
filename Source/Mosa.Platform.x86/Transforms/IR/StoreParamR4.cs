...
namespace Mosa.Platform.x86.Transforms.IR
{
	...
	/// StoreParamR4
	/// </summary>
	public sealed class StoreParamR4 : BaseTransformation
	{
		public StoreParamR4() : base(IRInstruction.StoreParamR4, TransformationType.Manual | TransformationType.Transform)
		{
		}
