...
namespace Mosa.Platform.x86.Transforms.FinalTweak
{
	...
	/// MovStore16
	/// </summary>
	public sealed class MovStore16 : BaseTransformation
	{
		public MovStore16() : base(X86.MovStore16, TransformationType.Manual | TransformationType.Tranformation)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			{
				temporaryRegister = Operand.CreateCPURegister(transformContext.I4, CPURegister.EAX);
			}
			else if (dest.Register != CPURegister.EBX && offset.Register != CPURegister.EBX)
			{
				temporaryRegister = Operand.CreateCPURegister(transformContext.I4, CPURegister.EBX);
			}
			else if (dest.Register != CPURegister.ECX && offset.Register != CPURegister.ECX)
			{
				temporaryRegister = Operand.CreateCPURegister(transformContext.I4, CPURegister.ECX);
			}
			else
			{
				temporaryRegister = Operand.CreateCPURegister(transformContext.I4, CPURegister.EDX);
			}
