...
namespace Mosa.Platform.x86
{
	...
	public static class X86
	{
		...
		public static readonly SetOverflow SetOverflow = new SetOverflow();
		public static readonly SetNoOverflow SetNoOverflow = new SetNoOverflow();
		public static readonly SetCarry SetCarry = new SetCarry();
		public static readonly SetUnsignedLessThan SetUnsignedLessThan = new SetUnsignedLessThan();
		public static readonly SetUnsignedGreaterOrEqual SetUnsignedGreaterOrEqual = new SetUnsignedGreaterOrEqual();
		public static readonly SetNoCarry SetNoCarry = new SetNoCarry();
		public static readonly SetEqual SetEqual = new SetEqual();
		public static readonly SetZero SetZero = new SetZero();
		public static readonly SetNotEqual SetNotEqual = new SetNotEqual();
		public static readonly SetNotZero SetNotZero = new SetNotZero();
		public static readonly SetUnsignedLessOrEqual SetUnsignedLessOrEqual = new SetUnsignedLessOrEqual();
		public static readonly SetUnsignedGreaterThan SetUnsignedGreaterThan = new SetUnsignedGreaterThan();
		public static readonly SetSigned SetSigned = new SetSigned();
		public static readonly SetNotSigned SetNotSigned = new SetNotSigned();
		public static readonly SetParity SetParity = new SetParity();
		public static readonly SetNoParity SetNoParity = new SetNoParity();
		public static readonly SetLessThan SetLessThan = new SetLessThan();
		public static readonly SetGreaterOrEqual SetGreaterOrEqual = new SetGreaterOrEqual();
