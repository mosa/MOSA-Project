...
namespace Mosa.Platforms.x86.Intrinsic
{
	...
	/// 
	/// </summary>
	public sealed class Set64 : IIntrinsicMethod
	{
		...
		public void ReplaceIntrinsicCall(Context context)
		{
			...
			MemoryOperand memory = new MemoryOperand(new Mosa.Runtime.Metadata.Signatures.SigType(Mosa.Runtime.Metadata.CilElementType.U8), GeneralPurposeRegister.EDX, new IntPtr(0));
