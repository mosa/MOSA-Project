...
namespace Mosa.Compiler.Framework.Transformation.IR.ConstantFolding
{
	public sealed class ArithShiftRight32 : BaseTransformation
	{
		...
		{
			transformContext.SetResultToConstant(context, ((ulong)(((long)context.Operand1.ConstantUnsignedLongInteger) >> (int)context.Operand2.ConstantUnsignedLongInteger)) & 0xFFFFFFFF);
		}
	}
}
