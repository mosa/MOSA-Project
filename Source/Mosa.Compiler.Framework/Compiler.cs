	...
	public sealed class Compiler
	{
		...
		private static List<BaseMethodCompilerStage> GetDefaultMethodPipeline(CompilerSettings compilerSettings, bool is64BitPlatform)
		{
			return new List<BaseMethodCompilerStage>() {
				...
				(compilerSettings.BasicOptimizations) ? new OptimizationStage(false, false) : null,
				(compilerSettings.SSA) ? new EdgeSplitStage() : null,
				(compilerSettings.SSA) ? new EnterSSAStage() : null,
				(compilerSettings.BasicOptimizations && compilerSettings.SSA) ? new OptimizationStage(true, false) : null,
				...
				(compilerSettings.BasicOptimizations && compilerSettings.SSA && (compilerSettings.BasicOptimizations || compilerSettings.ValueNumbering || compilerSettings.LoopInvariantCodeMotion || compilerSettings.SparseConditionalConstantPropagation)) ? new OptimizationStage(true,true) : null,

				//(compilerSettings.LongExpansion && !is64BitPlatform) ? new LongExpansionStage() : null,
				//(compilerSettings.BasicOptimizations && compilerSettings.LongExpansion && !is64BitPlatform) ? new OptimizationStage(true, true) : null,
				...
				(compilerSettings.TwoPass && compilerSettings.BasicOptimizations && compilerSettings.SSA) ? new OptimizationStage(true, true) : null,
