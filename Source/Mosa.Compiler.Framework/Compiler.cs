	...
	public sealed class Compiler
	{
		...
		private static List<BaseMethodCompilerStage> GetDefaultMethodPipeline(CompilerOptions compilerOptions)
		{
			return new List<BaseMethodCompilerStage>() {
				...
				(compilerOptions.EnableIROptimizations && compilerOptions.EnableSSA) ? new OptimizationStage() : null,
				...
				(compilerOptions.EnableIROptimizations && compilerOptions.EnableLongExpansion && compilerOptions.Architecture.NativePointerSize == 4) ? new OptimizationStage() : null,
