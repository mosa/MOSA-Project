...
namespace Mosa.Compiler.Framework.Linker
{
	...
	/// </summary>
	public abstract class BaseLinkerStage : BaseCompilerStage, ICompilerStage, ILinker
	{
		#region Data members
		...
		/// <summary>
		/// Initializes a new instance of <see cref="BaseLinkerStage"/>.
		/// </summary>
		protected BaseLinkerStage()
		{
