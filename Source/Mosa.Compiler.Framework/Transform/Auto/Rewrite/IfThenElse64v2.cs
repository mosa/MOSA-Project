...
namespace Mosa.Compiler.Framework.Transform.Auto.Rewrite
{
	...
	/// IfThenElse64v2
	/// </summary>
	public sealed class IfThenElse64v2 : BaseTransformation
	{
		public IfThenElse64v2() : base(IRInstruction.IfThenElse64)
		{
		}
	...
	/// IfThenElse64v2_v1
	/// </summary>
	public sealed class IfThenElse64v2_v1 : BaseTransformation
	{
		public IfThenElse64v2_v1() : base(IRInstruction.IfThenElse64)
		{
		}
