...
namespace Mosa.Compiler.Framework.Transform.Auto.Rewrite
{
	...
	/// IfThenElse32v4
	/// </summary>
	public sealed class IfThenElse32v4 : BaseTransformation
	{
		public IfThenElse32v4() : base(IRInstruction.IfThenElse32)
		{
		}
	...
	/// IfThenElse32v4_v1
	/// </summary>
	public sealed class IfThenElse32v4_v1 : BaseTransformation
	{
		public IfThenElse32v4_v1() : base(IRInstruction.IfThenElse32)
		{
		}
