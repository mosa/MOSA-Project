...
namespace Mosa.Compiler.Framework.Transform.Auto.ConstantFolding
{
	...
	/// </summary>
	public sealed class LoadZeroExtend32x64FoldAdd64 : BaseTransformation
	{
		public LoadZeroExtend32x64FoldAdd64() : base(IRInstruction.LoadZeroExtend32x64, TransformationType.Auto| TransformationType.Optimization)
		{
		}
