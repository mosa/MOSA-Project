...
namespace Mosa.Compiler.Framework.Transform.Auto
{
	...
	public static class AutoTransforms
	{
		public static readonly List<BaseTransformation> List = new List<BaseTransformation> {
			 ...
			 new IR.Simplification.CompareObjectSameAndEqual(),
			 new IR.Simplification.CompareObjectSameAndNotEqual(),
			 new IR.Simplification.Compare32x32SameAndEqual(),
			 new IR.Simplification.Compare32x64SameAndEqual(),
			 new IR.Simplification.Compare64x32SameAndEqual(),
			 new IR.Simplification.Compare64x64SameAndEqual(),
			 new IR.Simplification.Compare32x32SameAndNotEqual(),
			 new IR.Simplification.Compare32x64SameAndNotEqual(),
			 new IR.Simplification.Compare64x32SameAndNotEqual(),
			 new IR.Simplification.Compare64x64SameAndNotEqual(),
