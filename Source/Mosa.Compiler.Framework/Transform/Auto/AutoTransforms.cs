...
namespace Mosa.Compiler.Framework.Transform.Auto
{
	...
	public static class AutoTransforms
	{
		public static readonly List<BaseTransformation> List = new List<BaseTransformation> {
			 ...
			 new Reassociation.Add32v1(),
			 new Reassociation.Add32v1_v1(),
			 new Reassociation.Add64v1(),
			 new Reassociation.Add64v1_v1(),
			 new Reassociation.Sub32v1(),
			 new Reassociation.Sub32v1_v1(),
			 new Reassociation.Sub64v1(),
			 new Reassociation.Sub64v1_v1(),
			 ...
			 new Rewrite.IfThenElse32v1(),
			 new Rewrite.IfThenElse32v1_v1(),
			 new Rewrite.IfThenElse64v1(),
			 new Rewrite.IfThenElse64v1_v1(),
			 new Rewrite.IfThenElse32v2(),
			 new Rewrite.IfThenElse32v2_v1(),
			 new Rewrite.IfThenElse64v2(),
			 new Rewrite.IfThenElse64v2_v1(),
			 new Rewrite.IfThenElse32v3(),
			 new Rewrite.IfThenElse32v3_v1(),
			 new Rewrite.IfThenElse64v3(),
			 new Rewrite.IfThenElse64v3_v1(),
			 new Rewrite.IfThenElse32v4(),
			 new Rewrite.IfThenElse32v4_v1(),
			 new Rewrite.IfThenElse64v4(),
			 new Rewrite.IfThenElse64v4_v1(),
