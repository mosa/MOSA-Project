...
namespace Mosa.Compiler.Framework.Transform.Auto.ConstantMove
{
	...
	public sealed class MulSigned64Expression_v1 : BaseTransformation
	{
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			context.AppendInstruction(IRInstruction.MulSigned64, result, v1, t2);
		}
	}
	...
	public sealed class MulSigned64Expression_v3 : BaseTransformation
	{
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			context.SetInstruction(IRInstruction.MulSigned64, v1, t3, t2);
			context.AppendInstruction(IRInstruction.MulSigned64, result, v1, t1);
		}
	}
}
