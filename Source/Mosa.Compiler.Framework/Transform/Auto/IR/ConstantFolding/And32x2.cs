...
namespace Mosa.Compiler.Framework.Transform.Auto.IR.ConstantFolding
{
	...
	public sealed class And32x2 : BaseTransformation
	{
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			var e1 = transformContext.CreateConstant(And32(To32(t2), To32(t3)));
	...
	/// And32x2v1
	/// </summary>
	public sealed class And32x2v1 : BaseTransformation
	{
		public And32x2v1() : base(IRInstruction.And32)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			var e1 = transformContext.CreateConstant(And32(To32(t3), To32(t1)));
	...
	/// And32x2v2
	/// </summary>
	public sealed class And32x2v2 : BaseTransformation
	{
		public And32x2v2() : base(IRInstruction.And32)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			var e1 = transformContext.CreateConstant(And32(To32(t1), To32(t3)));
	...
	/// And32x2v3
	/// </summary>
	public sealed class And32x2v3 : BaseTransformation
	{
		public And32x2v3() : base(IRInstruction.And32)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			var e1 = transformContext.CreateConstant(And32(To32(t2), To32(t1)));
