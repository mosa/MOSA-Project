...
namespace Mosa.Compiler.Framework.Transform.Auto.IR.Algebraic
{
	...
	public sealed class Unsigned32PerfectSquareFormula : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand2), Sqrt32(DivUnsigned32(To32(context.Operand1.Definitions[0].Operand2.Definitions[0].Operand1), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v1 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand1), Sqrt32(DivUnsigned32(To32(context.Operand2.Definitions[0].Operand2.Definitions[0].Operand1), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v2 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand2), Sqrt32(DivUnsigned32(To32(context.Operand1.Definitions[0].Operand1.Definitions[0].Operand1), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v3 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand1), Sqrt32(DivUnsigned32(To32(context.Operand2.Definitions[0].Operand1.Definitions[0].Operand1), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v4 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand2), Sqrt32(DivUnsigned32(To32(context.Operand1.Definitions[0].Operand2.Definitions[0].Operand2), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v5 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand1), Sqrt32(DivUnsigned32(To32(context.Operand2.Definitions[0].Operand2.Definitions[0].Operand2), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v6 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand2), Sqrt32(DivUnsigned32(To32(context.Operand1.Definitions[0].Operand1.Definitions[0].Operand2), 2))))
				return false;
	...
	public sealed class Unsigned32PerfectSquareFormula_v7 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (!IsEqual(To32(context.Operand1), Sqrt32(DivUnsigned32(To32(context.Operand2.Definitions[0].Operand1.Definitions[0].Operand2), 2))))
				return false;
