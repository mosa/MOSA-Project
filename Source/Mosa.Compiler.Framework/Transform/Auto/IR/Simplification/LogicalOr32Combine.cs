...
namespace Mosa.Compiler.Framework.Transform.Auto.IR.Simplification
{
	...
	/// LogicalOr32Combine
	/// </summary>
	public sealed class LogicalOr32Combine : BaseTransformation
	{
		public LogicalOr32Combine() : base(IRInstruction.LogicalOr32)
		{
		}
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			if (context.Operand1.Definitions[0].Instruction != IRInstruction.LogicalOr32)
				return false;
