...
namespace Mosa.Compiler.Framework.Transform.Manual.LowerTo32
{
	...
	{
		public Compare64x32RestInSSA() : base(IRInstruction.Compare64x32)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			// Exit
			newBlocks[4].AppendInstruction(IRInstruction.Phi32, result, transformContext.CreateConstant((uint)1), transformContext.ConstantZero32);
