...
{
	public sealed class Compare64x64EqualOrNotEqual : BaseTransformation
	{
		public Compare64x64EqualOrNotEqual() : base(IRInstruction.Compare64x64, TransformationType.Manual | TransformationType.Optimization, true)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			context.AppendInstruction(IRInstruction.Compare32x32, condition, resultLow, v3, transformContext.ConstantZero32);
			context.AppendInstruction(IRInstruction.Move32, condition, resultHigh, transformContext.ConstantZero64);
		}
	}
}
