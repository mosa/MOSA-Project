...
namespace Mosa.Compiler.Framework.Transform.Manual.IR.Rewrite
{
	...
	{
		public CompareIntBranch32From64() : base(IRInstruction.CompareIntBranch32)
		{
		}
		...
		public override void Transform(Context context, TransformContext transformContext)
		{
			...
			context.SetInstruction(IRInstruction.CompareIntBranch64, conditionCode, null, node2.Operand1, node2.Operand2, context.BranchTargets[0]);
		}
	}
}
