...
{
	public sealed class Compare64x32NotSame : BaseTransformation
	{
		public Compare64x32NotSame() : base(IRInstruction.Compare64x32)
		{
		}
		...
		{
			context.SetInstruction(IRInstruction.Move64, context.Result, transformContext.ConstantZero32);
		}
	}
}
