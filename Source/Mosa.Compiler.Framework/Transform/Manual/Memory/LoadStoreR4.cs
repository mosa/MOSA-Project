...
namespace Mosa.Compiler.Framework.Transform.Manual.Memory
{
	public sealed class LoadStoreR4 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			var previous = GetPreviousNodeUntil(context, IRInstruction.StoreR4, out bool immediatePrevious);
		...
		{
			var previous = GetPreviousNodeUntil(context, IRInstruction.StoreR4, out _);
