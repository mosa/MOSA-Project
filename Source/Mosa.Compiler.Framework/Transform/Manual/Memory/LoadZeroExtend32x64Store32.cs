...
namespace Mosa.Compiler.Framework.Transform.Manual.Memory
{
	public sealed class LoadZeroExtend32x64Store32 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			var previous = GetPreviousNodeUntil(context, IRInstruction.Store32, transformContext.Window, out bool immediate);
		...
		{
			var previous = GetPreviousNodeUntil(context, IRInstruction.Store32, transformContext.Window);
