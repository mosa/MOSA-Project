...
namespace Mosa.Compiler.Framework.Transform.Manual.Memory
{
	public sealed class LoadZeroExtend16x32Store16 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			var previous = GetPreviousNodeUntil(context, IRInstruction.Store16, transformContext.Window, out bool immediate);
		...
		{
			var previous = GetPreviousNodeUntil(context, IRInstruction.Store16, transformContext.Window);
