...
namespace Mosa.Compiler.Framework.Transform.Manual.Memory
{
	public sealed class LoadStoreR8 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			...
			var previous = GetPreviousNodeUntil(context, IRInstruction.StoreR8, transformContext.Window, out bool immediate);
		...
		{
			var previous = GetPreviousNodeUntil(context, IRInstruction.StoreR8, transformContext.Window);
