	...
	public sealed class DoubleLoadR4 : BaseTransformation
	{
		...
		public override bool Match(Context context, TransformContext transformContext)
		{
			if (!context.Operand2.IsResolvedConstant)
				return false;
			var previous = GetPreviousNodeUntil(context, IRInstruction.LoadR4, out _, context.Result);
		...
		{
			var previous = GetPreviousNodeUntil(context, IRInstruction.LoadR4, out _);
