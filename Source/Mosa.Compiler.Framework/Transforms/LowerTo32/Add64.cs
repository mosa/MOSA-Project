...
{
	public Add64() : base(Framework.IR.Add64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction2(Framework.IR.AddCarryOut32, resultLow, resultCarry, op0Low, op1Low);
		context.AppendInstruction(Framework.IR.AddCarryIn32, resultHigh, op0High, op1High, resultCarry);
