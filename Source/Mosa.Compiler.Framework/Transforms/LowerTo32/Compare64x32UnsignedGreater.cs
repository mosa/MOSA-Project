...
{
	public Compare64x32UnsignedGreater() : base(Framework.IR.Compare64x32, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.Compare32x32, ConditionCode.UnsignedGreater, v1, op0High, op1High);
		context.AppendInstruction(Framework.IR.Compare32x32, ConditionCode.Equal, v2, op0High, op1High);
		context.AppendInstruction(Framework.IR.Compare32x32, ConditionCode.UnsignedGreater, v3, op0Low, op1Low);

		context.AppendInstruction(Framework.IR.And32, v4, v2, v3);
		context.AppendInstruction(Framework.IR.Or32, v5, v1, v4);

		//context.AppendInstruction(IRInstruction.And32, result, v5, Operand.CreateConstant((uint)1));
		context.AppendInstruction(Framework.IR.IfThenElse32, result, v5, Operand.CreateConstant((uint)1), Operand.Constant32_0);
	}
}
