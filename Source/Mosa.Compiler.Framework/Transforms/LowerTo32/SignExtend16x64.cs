...
{
	public SignExtend16x64() : base(Framework.IR.SignExtend16x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.SignExtend16x32, resultLow, v1);
