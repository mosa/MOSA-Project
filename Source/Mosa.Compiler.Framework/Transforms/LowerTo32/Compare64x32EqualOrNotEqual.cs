...
{
	public static readonly Compare64x32EqualOrNotEqual Instance = new();

	private Compare64x32EqualOrNotEqual() : base(IR.Compare64x32, TransformType.Manual | TransformType.Optimization)
	{
	}
