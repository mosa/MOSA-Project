...
{
	public Compare64x64Rest() : base(Framework.IR.Compare64x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		// Success
		newBlocks[2].AppendInstruction(Framework.IR.Move32, tempLow, Operand.CreateConstant((uint)1));
		newBlocks[2].AppendInstruction(Framework.IR.Jmp, newBlocks[4].Block);

		// Failed
		newBlocks[3].AppendInstruction(Framework.IR.Move32, tempLow, Operand.Constant32_0);
		newBlocks[3].AppendInstruction(Framework.IR.Jmp, newBlocks[4].Block);

		// Exit
		newBlocks[4].AppendInstruction(Framework.IR.Move32, resultLow, tempLow);
		newBlocks[4].AppendInstruction(Framework.IR.Move32, resultHigh, Operand.Constant32_0);
