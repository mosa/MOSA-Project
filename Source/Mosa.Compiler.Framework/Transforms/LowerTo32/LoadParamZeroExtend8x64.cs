...
{
	public LoadParamZeroExtend8x64() : base(Framework.IR.LoadParamZeroExtend8x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.LoadParamZeroExtend8x32, resultLow, op0Low);
