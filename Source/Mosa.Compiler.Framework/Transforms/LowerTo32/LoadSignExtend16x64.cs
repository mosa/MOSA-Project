...
{
	public LoadSignExtend16x64() : base(Framework.IR.LoadSignExtend16x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.LoadSignExtend16x32, resultLow, addressLow, offset);
