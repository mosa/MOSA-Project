...
{
	public static readonly LoadZeroExtend32x64 Instance = new();

	private LoadZeroExtend32x64() : base(IR.LoadZeroExtend32x64, TransformType.Manual | TransformType.Optimization)
	{
	}
