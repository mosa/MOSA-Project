...
{
	public static readonly LoadSignExtend8x64 Instance = new();

	private LoadSignExtend8x64() : base(IR.LoadSignExtend8x64, TransformType.Manual | TransformType.Optimization)
	{
	}
