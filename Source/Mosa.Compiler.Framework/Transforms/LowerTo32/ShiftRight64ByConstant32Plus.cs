...
{
	public static readonly ShiftRight64ByConstant32Plus Instance = new();

	private ShiftRight64ByConstant32Plus() : base(IR.ShiftRight64, TransformType.Manual | TransformType.Optimization)
	{
	}
