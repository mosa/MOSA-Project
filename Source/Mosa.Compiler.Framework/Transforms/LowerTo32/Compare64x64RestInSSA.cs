...
{
	public Compare64x64RestInSSA() : base(Framework.IR.Compare64x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		// Exit
		newBlocks[4].AppendInstruction(Framework.IR.Phi64, resultLow, Operand.Constant64_1, Operand.Constant64_0);
