...
public sealed class IfThenElse64Compare64_v1 : BaseTransform
{
	public IfThenElse64Compare64_v1() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
