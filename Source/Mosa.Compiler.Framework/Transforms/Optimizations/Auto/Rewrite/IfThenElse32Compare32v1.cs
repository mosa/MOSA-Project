...
{
	public static readonly IfThenElse32Compare32v1 Instance = new();

	private IfThenElse32Compare32v1() : base(IR.IfThenElse32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly IfThenElse32Compare32v1_v1 Instance = new();

	private IfThenElse32Compare32v1_v1() : base(IR.IfThenElse32, TransformType.Auto | TransformType.Optimization)
	{
	}
