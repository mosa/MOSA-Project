...
/// <summary>
/// IfThenElse32Compare32v1
/// </summary>
public sealed class IfThenElse32Compare32v1 : BaseTransform
{
	public IfThenElse32Compare32v1() : base(IRInstruction.IfThenElse32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// IfThenElse32Compare32v1_v1
/// </summary>
public sealed class IfThenElse32Compare32v1_v1 : BaseTransform
{
	public IfThenElse32Compare32v1_v1() : base(IRInstruction.IfThenElse32, TransformType.Auto | TransformType.Optimization)
	{
	}
