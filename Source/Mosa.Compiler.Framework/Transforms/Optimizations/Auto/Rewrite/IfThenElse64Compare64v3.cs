...
{
	public IfThenElse64Compare64v3() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public IfThenElse64Compare64v3_v1() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
