...
{
	public static readonly IfThenElse64Compare64v3 Instance = new();

	private IfThenElse64Compare64v3() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly IfThenElse64Compare64v3_v1 Instance = new();

	private IfThenElse64Compare64v3_v1() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
