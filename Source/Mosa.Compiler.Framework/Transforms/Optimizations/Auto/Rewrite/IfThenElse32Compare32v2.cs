...
{
	public IfThenElse32Compare32v2() : base(IR.IfThenElse32, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public IfThenElse32Compare32v2_v1() : base(IR.IfThenElse32, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
