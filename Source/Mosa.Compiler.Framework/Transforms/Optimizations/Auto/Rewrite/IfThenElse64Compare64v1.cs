...
{
	public IfThenElse64Compare64v1() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public IfThenElse64Compare64v1_v1() : base(IR.IfThenElse64, TransformType.Auto | TransformType.Optimization)
	{
	}
