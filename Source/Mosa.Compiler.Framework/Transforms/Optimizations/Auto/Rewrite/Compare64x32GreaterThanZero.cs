...
{
	public static readonly Compare64x32GreaterThanZero Instance = new();

	private Compare64x32GreaterThanZero() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x32GreaterThanZero_v1 Instance = new();

	private Compare64x32GreaterThanZero_v1() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
