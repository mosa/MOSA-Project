...
namespace Mosa.Compiler.Framework.Transforms.Optimizations.Auto.Rewrite
{
	...
	/// </summary>
	public sealed class IfThenElse32Compare32v3 : BaseTransformation
	{
		public IfThenElse32Compare32v3() : base(IRInstruction.IfThenElse32, TransformationType.Auto | TransformationType.Optimization)
		{
		}
	...
	/// </summary>
	public sealed class IfThenElse32Compare32v3_v1 : BaseTransformation
	{
		public IfThenElse32Compare32v3_v1() : base(IRInstruction.IfThenElse32, TransformationType.Auto | TransformationType.Optimization)
		{
		}
