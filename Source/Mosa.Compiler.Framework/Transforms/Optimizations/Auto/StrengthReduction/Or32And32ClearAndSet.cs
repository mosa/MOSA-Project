...
{
	public static readonly Or32And32ClearAndSet Instance = new();

	private Or32And32ClearAndSet() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
...
{
	public static readonly Or32And32ClearAndSet_v1 Instance = new();

	private Or32And32ClearAndSet_v1() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
...
{
	public static readonly Or32And32ClearAndSet_v2 Instance = new();

	private Or32And32ClearAndSet_v2() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
...
{
	public static readonly Or32And32ClearAndSet_v3 Instance = new();

	private Or32And32ClearAndSet_v3() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
