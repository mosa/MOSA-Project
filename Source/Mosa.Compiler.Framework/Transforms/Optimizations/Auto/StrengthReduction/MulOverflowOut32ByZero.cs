...
{
	public static readonly MulOverflowOut32ByZero Instance = new();

	private MulOverflowOut32ByZero() : base(IR.MulOverflowOut32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
