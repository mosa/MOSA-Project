...
{
	public Compare64x64RemUnsigned() : base(Framework.IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Compare64x64RemUnsigned_v1() : base(Framework.IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
