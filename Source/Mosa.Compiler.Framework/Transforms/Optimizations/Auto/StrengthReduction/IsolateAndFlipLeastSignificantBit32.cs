...
{
	public static readonly IsolateAndFlipLeastSignificantBit32 Instance = new();

	private IsolateAndFlipLeastSignificantBit32() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Instruction != IR.ShiftRight32)
			return false;
		...
		if (context.Operand1.Definitions[0].Operand1.Definitions[0].Instruction != IR.ShiftLeft32)
			return false;
...
{
	public static readonly IsolateAndFlipLeastSignificantBit32_v1 Instance = new();

	private IsolateAndFlipLeastSignificantBit32_v1() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand2.Definitions[0].Instruction != IR.ShiftRight32)
			return false;
		...
		if (context.Operand2.Definitions[0].Operand1.Definitions[0].Instruction != IR.ShiftLeft32)
			return false;
