...
{
	public static readonly MulSigned64ByNegative1 Instance = new();

	private MulSigned64ByNegative1() : base(IR.MulSigned64, TransformType.Auto | TransformType.Optimization, 50)
	{
	}
...
{
	public static readonly MulSigned64ByNegative1_v1 Instance = new();

	private MulSigned64ByNegative1_v1() : base(IR.MulSigned64, TransformType.Auto | TransformType.Optimization, 50)
	{
	}
