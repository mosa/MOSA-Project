...
{
	public MulUnsigned32ByOne() : base(Framework.IR.MulUnsigned32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public MulUnsigned32ByOne_v1() : base(Framework.IR.MulUnsigned32, TransformType.Auto | TransformType.Optimization)
	{
	}
