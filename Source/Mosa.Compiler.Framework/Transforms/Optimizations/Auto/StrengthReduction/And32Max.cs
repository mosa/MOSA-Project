...
{
	public And32Max() : base(IR.And32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
...
{
	public And32Max_v1() : base(IR.And32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
