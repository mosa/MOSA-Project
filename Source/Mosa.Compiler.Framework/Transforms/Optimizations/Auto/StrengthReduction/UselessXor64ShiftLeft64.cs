...
{
	public static readonly UselessXor64ShiftLeft64 Instance = new();

	private UselessXor64ShiftLeft64() : base(IR.ShiftLeft64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly UselessXor64ShiftLeft64_v1 Instance = new();

	private UselessXor64ShiftLeft64_v1() : base(IR.ShiftLeft64, TransformType.Auto | TransformType.Optimization)
	{
	}
