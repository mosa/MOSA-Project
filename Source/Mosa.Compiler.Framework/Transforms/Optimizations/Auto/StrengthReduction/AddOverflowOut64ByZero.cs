...
{
	public static readonly AddOverflowOut64ByZero Instance = new();

	private AddOverflowOut64ByZero() : base(IR.AddOverflowOut64, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
