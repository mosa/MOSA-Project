...
{
	public static readonly RemUnsigned32ByPowerOfTwo Instance = new();

	private RemUnsigned32ByPowerOfTwo() : base(IR.RemUnsigned32, TransformType.Auto | TransformType.Optimization)
	{
	}
