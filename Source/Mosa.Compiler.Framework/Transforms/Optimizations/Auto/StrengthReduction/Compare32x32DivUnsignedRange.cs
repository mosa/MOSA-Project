...
{
	public Compare32x32DivUnsignedRange() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public Compare32x32DivUnsignedRange_v1() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
