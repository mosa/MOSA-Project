...
{
	public static readonly Compare32x32DivUnsignedRange Instance = new();

	private Compare32x32DivUnsignedRange() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32DivUnsignedRange_v1 Instance = new();

	private Compare32x32DivUnsignedRange_v1() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
