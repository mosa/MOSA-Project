...
{
	public And64Max() : base(IRInstruction.And64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public And64Max_v1() : base(IRInstruction.And64, TransformType.Auto | TransformType.Optimization)
	{
	}
