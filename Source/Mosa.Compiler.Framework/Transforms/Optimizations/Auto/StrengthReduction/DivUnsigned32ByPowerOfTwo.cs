...
{
	public static readonly DivUnsigned32ByPowerOfTwo Instance = new();

	private DivUnsigned32ByPowerOfTwo() : base(IR.DivUnsigned32, TransformType.Auto | TransformType.Optimization)
	{
	}
