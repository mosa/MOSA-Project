...
{
	public static readonly SubManagedPointerSame Instance = new();

	private SubManagedPointerSame() : base(IR.SubManagedPointer, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
