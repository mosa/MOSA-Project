...
{
	public static readonly MulCarryOut32ByZero Instance = new();

	private MulCarryOut32ByZero() : base(IR.MulCarryOut32, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
