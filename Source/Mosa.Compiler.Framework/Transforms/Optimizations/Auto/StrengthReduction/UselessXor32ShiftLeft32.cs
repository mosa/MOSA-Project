...
{
	public static readonly UselessXor32ShiftLeft32 Instance = new();

	private UselessXor32ShiftLeft32() : base(IR.ShiftLeft32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly UselessXor32ShiftLeft32_v1 Instance = new();

	private UselessXor32ShiftLeft32_v1() : base(IR.ShiftLeft32, TransformType.Auto | TransformType.Optimization)
	{
	}
