...
{
	public static readonly MulCarryOut64ByOne Instance = new();

	private MulCarryOut64ByOne() : base(IR.MulCarryOut64, TransformType.Auto | TransformType.Optimization, 80)
	{
	}
