...
{
	public static readonly Compare64x32DivUnsignedRange Instance = new();

	private Compare64x32DivUnsignedRange() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x32DivUnsignedRange_v1 Instance = new();

	private Compare64x32DivUnsignedRange_v1() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
