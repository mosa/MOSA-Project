...
{
	public static readonly Compare64x64DivUnsignedRange Instance = new();

	private Compare64x64DivUnsignedRange() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64DivUnsignedRange_v1 Instance = new();

	private Compare64x64DivUnsignedRange_v1() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
