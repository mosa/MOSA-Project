...
{
	public static readonly Or32Truncate64x32Truncate64x32 Instance = new();

	private Or32Truncate64x32Truncate64x32() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
