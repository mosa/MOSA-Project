...
{
	public static readonly DivSigned64ButNotSigned Instance = new();

	private DivSigned64ButNotSigned() : base(IR.DivSigned64, TransformType.Auto | TransformType.Optimization, 20)
	{
	}
