...
{
	public static readonly RemSigned64ButNotSigned Instance = new();

	private RemSigned64ButNotSigned() : base(IR.RemSigned64, TransformType.Auto | TransformType.Optimization, 20)
	{
	}
