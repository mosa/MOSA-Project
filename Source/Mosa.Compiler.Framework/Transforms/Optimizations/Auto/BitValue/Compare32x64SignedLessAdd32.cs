...
{
	public static readonly Compare32x64SignedLessAdd32 Instance = new();

	private Compare32x64SignedLessAdd32() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x64SignedLessAdd32_v1 Instance = new();

	private Compare32x64SignedLessAdd32_v1() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
