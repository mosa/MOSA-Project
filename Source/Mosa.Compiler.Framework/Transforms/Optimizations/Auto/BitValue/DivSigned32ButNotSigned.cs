...
{
	public static readonly DivSigned32ButNotSigned Instance = new();

	private DivSigned32ButNotSigned() : base(IR.DivSigned32, TransformType.Auto | TransformType.Optimization, 20)
	{
	}
