...
{
	public static readonly Compare32x64EqualAdd32 Instance = new();

	private Compare32x64EqualAdd32() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(IR.Compare32x64, ConditionCode.Equal, result, t1, v1);
	}
}

public sealed class Compare32x64EqualAdd32_v1 : BaseTransform
{
	public static readonly Compare32x64EqualAdd32_v1 Instance = new();

	private Compare32x64EqualAdd32_v1() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(IR.Compare32x64, ConditionCode.Equal, result, t2, v1);
	}
}
