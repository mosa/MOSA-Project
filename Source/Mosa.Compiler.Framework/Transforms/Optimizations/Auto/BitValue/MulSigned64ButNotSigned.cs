...
{
	public static readonly MulSigned64ButNotSigned Instance = new();

	private MulSigned64ButNotSigned() : base(IR.MulSigned64, TransformType.Auto | TransformType.Optimization, 20)
	{
	}
