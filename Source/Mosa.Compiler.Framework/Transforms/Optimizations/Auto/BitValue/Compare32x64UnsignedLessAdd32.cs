...
{
	public Compare32x64UnsignedLessAdd32() : base(Framework.IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.Compare32x64, ConditionCode.UnsignedLess, result, t1, v1);
	}
}
...
{
	public Compare32x64UnsignedLessAdd32_v1() : base(Framework.IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.Compare32x64, ConditionCode.UnsignedLess, result, t2, v1);
	}
}
