...
{
	public static readonly Compare64x32UnsignedLessAdd64 Instance = new();

	private Compare64x32UnsignedLessAdd64() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x32UnsignedLessAdd64_v1 Instance = new();

	private Compare64x32UnsignedLessAdd64_v1() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
