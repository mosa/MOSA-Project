...
{
	public static readonly Compare64x64EqualAdd64 Instance = new();

	private Compare64x64EqualAdd64() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64EqualAdd64_v1 Instance = new();

	private Compare64x64EqualAdd64_v1() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
