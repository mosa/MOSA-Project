...
{
	public static readonly Compare64x32EqualAdd64 Instance = new();

	private Compare64x32EqualAdd64() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(IR.Compare64x32, ConditionCode.Equal, result, t1, v1);
	}
}

public sealed class Compare64x32EqualAdd64_v1 : BaseTransform
{
	public static readonly Compare64x32EqualAdd64_v1 Instance = new();

	private Compare64x32EqualAdd64_v1() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(IR.Compare64x32, ConditionCode.Equal, result, t2, v1);
	}
}
