...
{
	public static readonly MulSigned32ButNotSigned Instance = new();

	private MulSigned32ButNotSigned() : base(IR.MulSigned32, TransformType.Auto | TransformType.Optimization, 20)
	{
	}
