...
{
	public static readonly Compare64x64UnsignedLessAdd64 Instance = new();

	private Compare64x64UnsignedLessAdd64() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(IR.Compare64x64, ConditionCode.UnsignedLess, result, t1, v1);
	}
}

public sealed class Compare64x64UnsignedLessAdd64_v1 : BaseTransform
{
	public static readonly Compare64x64UnsignedLessAdd64_v1 Instance = new();

	private Compare64x64UnsignedLessAdd64_v1() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(IR.Compare64x64, ConditionCode.UnsignedLess, result, t2, v1);
	}
}
