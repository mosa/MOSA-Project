...
{
	public static readonly Compare32x32SignedLessAdd32 Instance = new();

	private Compare32x32SignedLessAdd32() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32SignedLessAdd32_v1 Instance = new();

	private Compare32x32SignedLessAdd32_v1() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
