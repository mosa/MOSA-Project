...
{
	public static readonly Signed32PerfectSquareFormula Instance = new();

	private Signed32PerfectSquareFormula() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32PerfectSquareFormula_v1 Instance = new();

	private Signed32PerfectSquareFormula_v1() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand2.Definitions[0].Operand2.Definitions[0].Instruction != IR.MulSigned32)
			return false;
...
{
	public static readonly Signed32PerfectSquareFormula_v2 Instance = new();

	private Signed32PerfectSquareFormula_v2() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32PerfectSquareFormula_v3 Instance = new();

	private Signed32PerfectSquareFormula_v3() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32PerfectSquareFormula_v4 Instance = new();

	private Signed32PerfectSquareFormula_v4() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32PerfectSquareFormula_v5 Instance = new();

	private Signed32PerfectSquareFormula_v5() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32PerfectSquareFormula_v6 Instance = new();

	private Signed32PerfectSquareFormula_v6() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32PerfectSquareFormula_v7 Instance = new();

	private Signed32PerfectSquareFormula_v7() : base(IR.Add32, TransformType.Auto | TransformType.Optimization)
	{
	}
