...
{
	public static readonly Signed32AAPlusBBMinus2AB Instance = new();

	private Signed32AAPlusBBMinus2AB() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32AAPlusBBMinus2AB_v1 Instance = new();

	private Signed32AAPlusBBMinus2AB_v1() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32AAPlusBBMinus2AB_v2 Instance = new();

	private Signed32AAPlusBBMinus2AB_v2() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed32AAPlusBBMinus2AB_v3 Instance = new();

	private Signed32AAPlusBBMinus2AB_v3() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
