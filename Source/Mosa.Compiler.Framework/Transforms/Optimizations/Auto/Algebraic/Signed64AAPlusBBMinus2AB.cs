...
{
	public static readonly Signed64AAPlusBBMinus2AB Instance = new();

	private Signed64AAPlusBBMinus2AB() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64AAPlusBBMinus2AB_v1 Instance = new();

	private Signed64AAPlusBBMinus2AB_v1() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64AAPlusBBMinus2AB_v2 Instance = new();

	private Signed64AAPlusBBMinus2AB_v2() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64AAPlusBBMinus2AB_v3 Instance = new();

	private Signed64AAPlusBBMinus2AB_v3() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
