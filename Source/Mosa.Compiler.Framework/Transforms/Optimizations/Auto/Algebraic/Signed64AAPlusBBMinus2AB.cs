...
public sealed class Signed64AAPlusBBMinus2AB : BaseTransform
{
	public Signed64AAPlusBBMinus2AB() : base(Framework.IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Sub64, v1, t1, t2);
...
/// </summary>
[Transform("IR.Optimizations.Auto.Algebraic")]
public sealed class Signed64AAPlusBBMinus2AB_v1 : BaseTransform
{
	public Signed64AAPlusBBMinus2AB_v1() : base(Framework.IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// </summary>
[Transform("IR.Optimizations.Auto.Algebraic")]
public sealed class Signed64AAPlusBBMinus2AB_v2 : BaseTransform
{
	public Signed64AAPlusBBMinus2AB_v2() : base(Framework.IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Sub64, v1, t2, t1);
		context.AppendInstruction(Framework.IR.Sub64, v2, t2, t1);
		context.AppendInstruction(Framework.IR.MulSigned64, result, v2, v1);
	}
}
...
/// </summary>
[Transform("IR.Optimizations.Auto.Algebraic")]
public sealed class Signed64AAPlusBBMinus2AB_v3 : BaseTransform
{
	public Signed64AAPlusBBMinus2AB_v3() : base(Framework.IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
