...
{
	public Unsigned64AAPlusBBPlus2AB() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Operand1.Definitions[0].Instruction != Framework.IR.MulUnsigned64)
			return false;

		if (!context.Operand1.Definitions[0].Operand2.IsDefinedOnce)
			return false;

		if (context.Operand1.Definitions[0].Operand2.Definitions[0].Instruction != Framework.IR.MulUnsigned64)
			return false;

		if (!context.Operand2.IsDefinedOnce)
			return false;

		if (context.Operand2.Definitions[0].Instruction != Framework.IR.ShiftLeft64)
			return false;
		...
		if (context.Operand2.Definitions[0].Operand1.Definitions[0].Instruction != Framework.IR.MulSigned64)
			return false;
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.Add64, v2, t1, t2);
...
{
	public Unsigned64AAPlusBBPlus2AB_v1() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Operand1.Definitions[0].Instruction != Framework.IR.MulSigned64)
			return false;
		...
		if (context.Operand2.Definitions[0].Operand1.Definitions[0].Instruction != Framework.IR.MulUnsigned64)
			return false;

		if (!context.Operand2.Definitions[0].Operand2.IsDefinedOnce)
			return false;

		if (context.Operand2.Definitions[0].Operand2.Definitions[0].Instruction != Framework.IR.MulUnsigned64)
			return false;
...
{
	public Unsigned64AAPlusBBPlus2AB_v2() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Unsigned64AAPlusBBPlus2AB_v3() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Add64, v1, t2, t1);
		context.AppendInstruction(Framework.IR.Add64, v2, t2, t1);
		context.AppendInstruction(Framework.IR.MulUnsigned64, result, v2, v1);
	}
}
...
{
	public Unsigned64AAPlusBBPlus2AB_v4() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Unsigned64AAPlusBBPlus2AB_v5() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Unsigned64AAPlusBBPlus2AB_v6() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Unsigned64AAPlusBBPlus2AB_v7() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
