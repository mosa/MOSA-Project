...
{
	public static readonly Signed64PerfectSquareFormula Instance = new();

	private Signed64PerfectSquareFormula() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v1 Instance = new();

	private Signed64PerfectSquareFormula_v1() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v2 Instance = new();

	private Signed64PerfectSquareFormula_v2() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v3 Instance = new();

	private Signed64PerfectSquareFormula_v3() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v4 Instance = new();

	private Signed64PerfectSquareFormula_v4() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v5 Instance = new();

	private Signed64PerfectSquareFormula_v5() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v6 Instance = new();

	private Signed64PerfectSquareFormula_v6() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Signed64PerfectSquareFormula_v7 Instance = new();

	private Signed64PerfectSquareFormula_v7() : base(IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
