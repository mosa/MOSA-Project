...
{
	public Signed64PerfectSquareFormula() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Operand2.Definitions[0].Instruction != Framework.IR.MulSigned64)
			return false;
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Add64, v1, t1, e1);
		context.AppendInstruction(Framework.IR.Add64, v2, t1, e1);
		context.AppendInstruction(Framework.IR.MulSigned64, result, v2, v1);
	}
}
...
{
	public Signed64PerfectSquareFormula_v1() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand2.Definitions[0].Operand2.Definitions[0].Instruction != Framework.IR.MulSigned64)
			return false;
...
{
	public Signed64PerfectSquareFormula_v2() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Add64, v1, t2, e1);
		context.AppendInstruction(Framework.IR.Add64, v2, t2, e1);
		context.AppendInstruction(Framework.IR.MulSigned64, result, v2, v1);
	}
}
...
{
	public Signed64PerfectSquareFormula_v3() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Signed64PerfectSquareFormula_v4() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Signed64PerfectSquareFormula_v5() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Signed64PerfectSquareFormula_v6() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Signed64PerfectSquareFormula_v7() : base(Framework.IR.Add64, TransformType.Auto | TransformType.Optimization)
	{
	}
