...
{
	public Compare32x32PassThru2() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Compare32x32PassThru2_v1() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x32PassThru2_v2
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x32PassThru2_v2 : BaseTransform
{
	public Compare32x32PassThru2_v2() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x32PassThru2_v3
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x32PassThru2_v3 : BaseTransform
{
	public Compare32x32PassThru2_v3() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
