...
{
	public static readonly Compare32x32PassThru Instance = new();

	private Compare32x32PassThru() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32PassThru_v1 Instance = new();

	private Compare32x32PassThru_v1() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32PassThru_v2 Instance = new();

	private Compare32x32PassThru_v2() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32PassThru_v3 Instance = new();

	private Compare32x32PassThru_v3() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
