...
{
	public static readonly Compare64x32NotPassThru Instance = new();

	private Compare64x32NotPassThru() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x32NotPassThru_v1 Instance = new();

	private Compare64x32NotPassThru_v1() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x32NotPassThru_v2 Instance = new();

	private Compare64x32NotPassThru_v2() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x32NotPassThru_v3 Instance = new();

	private Compare64x32NotPassThru_v3() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
