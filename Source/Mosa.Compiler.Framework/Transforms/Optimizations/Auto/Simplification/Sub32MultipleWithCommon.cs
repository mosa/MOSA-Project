...
{
	public static readonly Sub32MultipleWithCommon Instance = new();

	private Sub32MultipleWithCommon() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Sub32MultipleWithCommon_v1 Instance = new();

	private Sub32MultipleWithCommon_v1() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Sub32MultipleWithCommon_v2 Instance = new();

	private Sub32MultipleWithCommon_v2() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Sub32MultipleWithCommon_v3 Instance = new();

	private Sub32MultipleWithCommon_v3() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization)
	{
	}
