...
{
	public static readonly Compare64x64SameAndNotEqual Instance = new();

	private Compare64x64SameAndNotEqual() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
