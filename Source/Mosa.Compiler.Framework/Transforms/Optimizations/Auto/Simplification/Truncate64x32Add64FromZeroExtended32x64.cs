...
{
	/// <summary>
	/// Truncate64x32Add64FromZeroExtended32x64
	/// </summary>
	public sealed class Truncate64x32Add64FromZeroExtended32x64 : BaseTransformation
	{
		public Truncate64x32Add64FromZeroExtended32x64() : base(IRInstruction.Truncate64x32, TransformationType.Auto | TransformationType.Optimization)
		{
		}
