...
{
	public static readonly Truncate64x32Or64FromZeroExtended32x64 Instance = new();

	private Truncate64x32Or64FromZeroExtended32x64() : base(IR.Truncate64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
