...
{
	public Compare64x64PassThru() : base(Framework.IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public Compare64x64PassThru_v1() : base(Framework.IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare64x64PassThru_v2
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare64x64PassThru_v2 : BaseTransform
{
	public Compare64x64PassThru_v2() : base(Framework.IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare64x64PassThru_v3
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare64x64PassThru_v3 : BaseTransform
{
	public Compare64x64PassThru_v3() : base(Framework.IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
