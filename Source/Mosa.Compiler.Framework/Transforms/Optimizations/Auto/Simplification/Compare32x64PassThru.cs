...
/// <summary>
/// Compare32x64PassThru
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x64PassThru : BaseTransform
{
	public Compare32x64PassThru() : base(IRInstruction.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x64PassThru_v1
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x64PassThru_v1 : BaseTransform
{
	public Compare32x64PassThru_v1() : base(IRInstruction.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x64PassThru_v2
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x64PassThru_v2 : BaseTransform
{
	public Compare32x64PassThru_v2() : base(IRInstruction.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x64PassThru_v3
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x64PassThru_v3 : BaseTransform
{
	public Compare32x64PassThru_v3() : base(IRInstruction.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
