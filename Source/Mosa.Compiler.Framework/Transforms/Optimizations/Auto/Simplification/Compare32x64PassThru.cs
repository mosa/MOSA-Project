...
{
	public static readonly Compare32x64PassThru Instance = new();

	private Compare32x64PassThru() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x64PassThru_v1 Instance = new();

	private Compare32x64PassThru_v1() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x64PassThru_v2 Instance = new();

	private Compare32x64PassThru_v2() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x64PassThru_v3 Instance = new();

	private Compare32x64PassThru_v3() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
