...
{
	public static readonly Or32Double Instance = new();

	private Or32Double() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Or32Double_v1 Instance = new();

	private Or32Double_v1() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Or32Double_v2 Instance = new();

	private Or32Double_v2() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Or32Double_v3 Instance = new();

	private Or32Double_v3() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
