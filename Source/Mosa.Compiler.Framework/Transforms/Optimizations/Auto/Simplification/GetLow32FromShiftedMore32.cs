...
{
	public static readonly GetLow32FromShiftedMore32 Instance = new();

	private GetLow32FromShiftedMore32() : base(IR.GetLow32, TransformType.Auto | TransformType.Optimization)
	{
	}
