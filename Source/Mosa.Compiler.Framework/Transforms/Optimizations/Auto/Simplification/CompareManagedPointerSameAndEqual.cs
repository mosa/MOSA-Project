...
{
	public static readonly CompareManagedPointerSameAndEqual Instance = new();

	private CompareManagedPointerSameAndEqual() : base(IR.CompareManagedPointer, TransformType.Auto | TransformType.Optimization)
	{
	}
