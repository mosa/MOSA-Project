...
{
	public static readonly Compare64x32SameAndNotEqual Instance = new();

	private Compare64x32SameAndNotEqual() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
