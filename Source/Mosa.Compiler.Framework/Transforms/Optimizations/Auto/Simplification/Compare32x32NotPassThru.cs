...
/// <summary>
/// Compare32x32NotPassThru
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x32NotPassThru : BaseTransform
{
	public Compare32x32NotPassThru() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.AppendInstruction(Framework.IR.And32, result, v1, c1);
	}
}

/// <summary>
/// Compare32x32NotPassThru_v1
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x32NotPassThru_v1 : BaseTransform
{
	public Compare32x32NotPassThru_v1() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x32NotPassThru_v2
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x32NotPassThru_v2 : BaseTransform
{
	public Compare32x32NotPassThru_v2() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare32x32NotPassThru_v3
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare32x32NotPassThru_v3 : BaseTransform
{
	public Compare32x32NotPassThru_v3() : base(Framework.IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
