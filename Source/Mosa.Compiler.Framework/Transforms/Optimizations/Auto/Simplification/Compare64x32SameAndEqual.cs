...
{
	public static readonly Compare64x32SameAndEqual Instance = new();

	private Compare64x32SameAndEqual() : base(IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
