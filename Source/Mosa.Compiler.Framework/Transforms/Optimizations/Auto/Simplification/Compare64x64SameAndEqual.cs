...
{
	public static readonly Compare64x64SameAndEqual Instance = new();

	private Compare64x64SameAndEqual() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
