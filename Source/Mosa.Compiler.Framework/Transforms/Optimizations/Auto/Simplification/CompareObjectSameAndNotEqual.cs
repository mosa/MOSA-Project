...
{
	public static readonly CompareObjectSameAndNotEqual Instance = new();

	private CompareObjectSameAndNotEqual() : base(IR.CompareObject, TransformType.Auto | TransformType.Optimization)
	{
	}
