...
{
	public static readonly SignExtend32x64Truncate64x32 Instance = new();

	private SignExtend32x64Truncate64x32() : base(IR.SignExtend32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
