...
/// <summary>
/// Compare64x32PassThru2
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare64x32PassThru2 : BaseTransform
{
	public Compare64x32PassThru2() : base(Framework.IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.And32, result, t1, c1);
	}
}

/// <summary>
/// Compare64x32PassThru2_v1
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare64x32PassThru2_v1 : BaseTransform
{
	public Compare64x32PassThru2_v1() : base(Framework.IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare64x32PassThru2_v2
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare64x32PassThru2_v2 : BaseTransform
{
	public Compare64x32PassThru2_v2() : base(Framework.IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
/// <summary>
/// Compare64x32PassThru2_v3
/// </summary>
[Transform("IR.Optimizations.Auto.Simplification")]
public sealed class Compare64x32PassThru2_v3 : BaseTransform
{
	public Compare64x32PassThru2_v3() : base(Framework.IR.Compare64x32, TransformType.Auto | TransformType.Optimization)
	{
	}
