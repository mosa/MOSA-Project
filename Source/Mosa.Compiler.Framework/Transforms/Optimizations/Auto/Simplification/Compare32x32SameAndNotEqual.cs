...
{
	public static readonly Compare32x32SameAndNotEqual Instance = new();

	private Compare32x32SameAndNotEqual() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
