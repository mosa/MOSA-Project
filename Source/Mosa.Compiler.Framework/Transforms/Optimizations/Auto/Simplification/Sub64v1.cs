...
{
	public static readonly Sub64v1 Instance = new();

	private Sub64v1() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Sub64v1_v1 Instance = new();

	private Sub64v1_v1() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization)
	{
	}
