...
{
	public static readonly GetHigh32FromShiftedMore32 Instance = new();

	private GetHigh32FromShiftedMore32() : base(IR.GetHigh32, TransformType.Auto | TransformType.Optimization)
	{
	}
