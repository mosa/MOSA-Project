...
{
	public static readonly GetHigh32FromRightLeftAndTo64 Instance = new();

	private GetHigh32FromRightLeftAndTo64() : base(IR.GetHigh32, TransformType.Auto | TransformType.Optimization)
	{
	}
