...
{
	public static readonly Compare64x64PassThru2 Instance = new();

	private Compare64x64PassThru2() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64PassThru2_v1 Instance = new();

	private Compare64x64PassThru2_v1() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64PassThru2_v2 Instance = new();

	private Compare64x64PassThru2_v2() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64PassThru2_v3 Instance = new();

	private Compare64x64PassThru2_v3() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
