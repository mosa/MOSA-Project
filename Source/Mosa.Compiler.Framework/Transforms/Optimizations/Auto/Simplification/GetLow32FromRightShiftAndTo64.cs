...
{
	public static readonly GetLow32FromRightShiftAndTo64 Instance = new();

	private GetLow32FromRightShiftAndTo64() : base(IR.GetLow32, TransformType.Auto | TransformType.Optimization)
	{
	}
