...
{
	public static readonly Compare64x64SwapToZero Instance = new();

	private Compare64x64SwapToZero() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64SwapToZero_v1 Instance = new();

	private Compare64x64SwapToZero_v1() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64SwapToZero_v2 Instance = new();

	private Compare64x64SwapToZero_v2() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare64x64SwapToZero_v3 Instance = new();

	private Compare64x64SwapToZero_v3() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization)
	{
	}
