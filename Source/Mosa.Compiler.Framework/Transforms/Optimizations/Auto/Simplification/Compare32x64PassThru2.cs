...
{
	public Compare32x64PassThru2() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public Compare32x64PassThru2_v1() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public Compare32x64PassThru2_v2() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public Compare32x64PassThru2_v3() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
