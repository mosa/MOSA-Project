...
{
	public static readonly Xor64Double Instance = new();

	private Xor64Double() : base(IR.Xor64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Xor64Double_v1 Instance = new();

	private Xor64Double_v1() : base(IR.Xor64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Xor64Double_v2 Instance = new();

	private Xor64Double_v2() : base(IR.Xor64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Xor64Double_v3 Instance = new();

	private Xor64Double_v3() : base(IR.Xor64, TransformType.Auto | TransformType.Optimization)
	{
	}
