...
{
	public static readonly Compare32x32SwapToZero Instance = new();

	private Compare32x32SwapToZero() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32SwapToZero_v1 Instance = new();

	private Compare32x32SwapToZero_v1() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32SwapToZero_v2 Instance = new();

	private Compare32x32SwapToZero_v2() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Compare32x32SwapToZero_v3 Instance = new();

	private Compare32x32SwapToZero_v3() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization)
	{
	}
