...
{
	public AddR4Expression() : base(IR.AddR4, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public AddR4Expression_v1() : base(IR.AddR4, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public AddR4Expression_v2() : base(IR.AddR4, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public AddR4Expression_v3() : base(IR.AddR4, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
