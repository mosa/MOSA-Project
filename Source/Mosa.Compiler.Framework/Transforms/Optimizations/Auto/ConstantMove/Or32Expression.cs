...
{
	public static readonly Or32Expression Instance = new();

	private Or32Expression() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Or32Expression_v1 Instance = new();

	private Or32Expression_v1() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Or32Expression_v2 Instance = new();

	private Or32Expression_v2() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly Or32Expression_v3 Instance = new();

	private Or32Expression_v3() : base(IR.Or32, TransformType.Auto | TransformType.Optimization)
	{
	}
