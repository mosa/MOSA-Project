...
{
	public static readonly Compare32x64GreaterOrEqualThanMax Instance = new();

	private Compare32x64GreaterOrEqualThanMax() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization, 100)
	{
	}
...
{
	public static readonly Compare32x64GreaterOrEqualThanMax_v1 Instance = new();

	private Compare32x64GreaterOrEqualThanMax_v1() : base(IR.Compare32x64, TransformType.Auto | TransformType.Optimization, 100)
	{
	}
