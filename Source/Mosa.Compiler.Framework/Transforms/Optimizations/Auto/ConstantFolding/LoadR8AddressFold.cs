...
{
	public static readonly LoadR8AddressFold Instance = new();

	private LoadR8AddressFold() : base(IR.LoadR8, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(IR.LoadParamR8, result, t1);
	}
}
