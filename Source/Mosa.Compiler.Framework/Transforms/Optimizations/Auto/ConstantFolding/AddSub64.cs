...
{
	public AddSub64() : base(IR.Add64, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public AddSub64_v1() : base(IR.Add64, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
