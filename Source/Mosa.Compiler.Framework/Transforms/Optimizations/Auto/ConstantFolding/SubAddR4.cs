...
{
	public SubAddR4() : base(IR.SubR4, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public SubAddR4_v1() : base(IR.SubR4, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
