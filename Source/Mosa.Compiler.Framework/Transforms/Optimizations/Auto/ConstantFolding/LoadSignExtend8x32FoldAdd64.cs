...
{
	public static readonly LoadSignExtend8x32FoldAdd64 Instance = new();

	private LoadSignExtend8x32FoldAdd64() : base(IR.LoadSignExtend8x32, TransformType.Auto | TransformType.Optimization)
	{
	}
