...
{
	public static readonly LoadManagedPointerFoldAdd32 Instance = new();

	private LoadManagedPointerFoldAdd32() : base(IR.LoadManagedPointer, TransformType.Auto | TransformType.Optimization)
	{
	}
