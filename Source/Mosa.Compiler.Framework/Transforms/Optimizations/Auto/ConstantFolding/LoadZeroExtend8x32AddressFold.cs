...
{
	public static readonly LoadZeroExtend8x32AddressFold Instance = new();

	private LoadZeroExtend8x32AddressFold() : base(IR.LoadZeroExtend8x32, TransformType.Auto | TransformType.Optimization)
	{
	}
