...
namespace Mosa.Compiler.Framework.Transforms.Optimizations.Auto.ConstantFolding
{
	...
	public sealed class MulSigned32x2 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(MulSigned32(ToSigned32(t2), ToSigned32(t3)));
	...
	public sealed class MulSigned32x2_v1 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(MulSigned32(ToSigned32(t3), ToSigned32(t1)));
	...
	public sealed class MulSigned32x2_v2 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(MulSigned32(ToSigned32(t1), ToSigned32(t3)));
	...
	public sealed class MulSigned32x2_v3 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(MulSigned32(ToSigned32(t2), ToSigned32(t1)));
