...
{
	public static readonly LoadZeroExtend16x64FoldAdd64 Instance = new();

	private LoadZeroExtend16x64FoldAdd64() : base(IR.LoadZeroExtend16x64, TransformType.Auto | TransformType.Optimization)
	{
	}
