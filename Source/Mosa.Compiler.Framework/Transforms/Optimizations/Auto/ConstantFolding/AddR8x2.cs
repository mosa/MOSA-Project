...
{
	public AddR8x2() : base(IR.AddR8, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public AddR8x2_v1() : base(IR.AddR8, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public AddR8x2_v2() : base(IR.AddR8, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public AddR8x2_v3() : base(IR.AddR8, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
