...
{
	public static readonly MulR4x2 Instance = new();

	private MulR4x2() : base(IR.MulR4, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public static readonly MulR4x2_v1 Instance = new();

	private MulR4x2_v1() : base(IR.MulR4, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public static readonly MulR4x2_v2 Instance = new();

	private MulR4x2_v2() : base(IR.MulR4, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public static readonly MulR4x2_v3 Instance = new();

	private MulR4x2_v3() : base(IR.MulR4, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
