...
{
	public static readonly AddCarryIn64Outside2 Instance = new();

	private AddCarryIn64Outside2() : base(IR.AddCarryIn64, TransformType.Auto | TransformType.Optimization)
	{
	}
