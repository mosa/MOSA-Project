...
{
	public SubAdd64() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public SubAdd64_v1() : base(IR.Sub64, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
