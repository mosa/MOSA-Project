...
{
	public static readonly LoadSignExtend16x64AddressFold Instance = new();

	private LoadSignExtend16x64AddressFold() : base(IR.LoadSignExtend16x64, TransformType.Auto | TransformType.Optimization)
	{
	}
