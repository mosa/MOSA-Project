...
{
	public MulSignedShiftLeft32() : base(IR.MulSigned32, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
...
{
	public MulSignedShiftLeft32_v1() : base(IR.MulSigned32, TransformType.Auto | TransformType.Optimization, 95)
	{
	}
