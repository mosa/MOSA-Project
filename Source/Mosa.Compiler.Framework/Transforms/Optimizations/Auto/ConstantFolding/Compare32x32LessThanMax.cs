...
{
	public static readonly Compare32x32LessThanMax Instance = new();

	private Compare32x32LessThanMax() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization, 100)
	{
	}
...
{
	public static readonly Compare32x32LessThanMax_v1 Instance = new();

	private Compare32x32LessThanMax_v1() : base(IR.Compare32x32, TransformType.Auto | TransformType.Optimization, 100)
	{
	}
