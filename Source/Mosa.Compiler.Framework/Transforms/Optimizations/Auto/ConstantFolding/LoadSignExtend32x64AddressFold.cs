...
{
	public static readonly LoadSignExtend32x64AddressFold Instance = new();

	private LoadSignExtend32x64AddressFold() : base(IR.LoadSignExtend32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
