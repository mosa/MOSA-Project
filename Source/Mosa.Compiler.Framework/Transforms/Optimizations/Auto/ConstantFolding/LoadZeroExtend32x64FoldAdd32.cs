...
{
	public static readonly LoadZeroExtend32x64FoldAdd32 Instance = new();

	private LoadZeroExtend32x64FoldAdd32() : base(IR.LoadZeroExtend32x64, TransformType.Auto | TransformType.Optimization)
	{
	}
