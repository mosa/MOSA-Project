...
{
	public And32x2() : base(Framework.IR.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public And32x2_v1() : base(Framework.IR.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.And32, result, t2, e1);
	}
}
...
{
	public And32x2_v2() : base(Framework.IR.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public And32x2_v3() : base(Framework.IR.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.And32, result, t3, e1);
	}
}
