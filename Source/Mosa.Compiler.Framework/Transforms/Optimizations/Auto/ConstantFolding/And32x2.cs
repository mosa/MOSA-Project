...
namespace Mosa.Compiler.Framework.Transforms.Optimizations.Auto.ConstantFolding
{
	...
	public sealed class And32x2 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(And32(To32(t2), To32(t3)));
	...
	public sealed class And32x2_v1 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(And32(To32(t3), To32(t1)));
	...
	public sealed class And32x2_v2 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(And32(To32(t1), To32(t3)));
	...
	public sealed class And32x2_v3 : BaseTransform
	{
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			var e1 = transform.CreateConstant(And32(To32(t2), To32(t1)));
