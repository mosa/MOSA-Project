...
{
	public static readonly LoadSignExtend8x32FoldAdd32 Instance = new();

	private LoadSignExtend8x32FoldAdd32() : base(IR.LoadSignExtend8x32, TransformType.Auto | TransformType.Optimization)
	{
	}
