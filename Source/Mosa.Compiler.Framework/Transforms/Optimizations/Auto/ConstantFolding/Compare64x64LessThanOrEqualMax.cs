...
{
	public static readonly Compare64x64LessThanOrEqualMax Instance = new();

	private Compare64x64LessThanOrEqualMax() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization, 100)
	{
	}
...
{
	public static readonly Compare64x64LessThanOrEqualMax_v1 Instance = new();

	private Compare64x64LessThanOrEqualMax_v1() : base(IR.Compare64x64, TransformType.Auto | TransformType.Optimization, 100)
	{
	}
