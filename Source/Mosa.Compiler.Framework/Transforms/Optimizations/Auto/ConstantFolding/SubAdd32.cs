...
{
	public SubAdd32() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public SubAdd32_v1() : base(IR.Sub32, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
