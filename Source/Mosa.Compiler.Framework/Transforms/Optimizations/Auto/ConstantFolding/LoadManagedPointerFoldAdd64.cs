...
{
	public static readonly LoadManagedPointerFoldAdd64 Instance = new();

	private LoadManagedPointerFoldAdd64() : base(IR.LoadManagedPointer, TransformType.Auto | TransformType.Optimization)
	{
	}
