...
{
	public static readonly Or32x2 Instance = new();

	private Or32x2() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public static readonly Or32x2_v1 Instance = new();

	private Or32x2_v1() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public static readonly Or32x2_v2 Instance = new();

	private Or32x2_v2() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
...
{
	public static readonly Or32x2_v3 Instance = new();

	private Or32x2_v3() : base(IR.Or32, TransformType.Auto | TransformType.Optimization, 90)
	{
	}
