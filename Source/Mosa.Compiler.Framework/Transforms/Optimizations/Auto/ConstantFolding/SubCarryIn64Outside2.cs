...
{
	public static readonly SubCarryIn64Outside2 Instance = new();

	private SubCarryIn64Outside2() : base(IR.SubCarryIn64, TransformType.Auto | TransformType.Optimization)
	{
	}
