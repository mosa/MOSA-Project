...
public static class AutoTransforms
{
	public static readonly List<BaseTransform> List = new() {
		...
		new ConstantFolding.Compare32x32GreaterOrEqualThanZero_v1(),
		new ConstantFolding.Compare32x64GreaterOrEqualThanZero(),
		new ConstantFolding.Compare32x64GreaterOrEqualThanZero_v1(),
		new ConstantFolding.Compare64x32GreaterOrEqualThanZero(),
		new ConstantFolding.Compare64x32GreaterOrEqualThanZero_v1(),
		new ConstantFolding.Compare64x64GreaterOrEqualThanZero(),
		new ConstantFolding.Compare64x64GreaterOrEqualThanZero_v1(),
		new ConstantFolding.Compare32x32LessThanZero(),
		new ConstantFolding.Compare32x32LessThanZero_v1(),
		new ConstantFolding.Compare32x64LessThanZero(),
		new ConstantFolding.Compare32x64LessThanZero_v1(),
		new ConstantFolding.Compare64x32LessThanZero(),
		new ConstantFolding.Compare64x32LessThanZero_v1(),
		new ConstantFolding.Compare64x64LessThanZero(),
		new ConstantFolding.Compare64x64LessThanZero_v1(),
		new ConstantFolding.Compare32x32LessOrEqualThanZero(),
		new ConstantFolding.Compare32x32LessOrEqualThanZero_v1(),
		new ConstantFolding.Compare32x64LessOrEqualThanZero(),
		new ConstantFolding.Compare32x64LessOrEqualThanZero_v1(),
		new ConstantFolding.Compare64x32LessOrEqualThanZero(),
		new ConstantFolding.Compare64x32LessOrEqualThanZero_v1(),
		new ConstantFolding.Compare64x64LessOrEqualThanZero(),
		new ConstantFolding.Compare64x64LessOrEqualThanZero_v1(),
		new ConstantFolding.Compare32x32GreaterOrEqualThanMax(),
		new ConstantFolding.Compare32x32GreaterOrEqualThanMax_v1(),
		new ConstantFolding.Compare32x64GreaterOrEqualThanMax(),
		new ConstantFolding.Compare32x64GreaterOrEqualThanMax_v1(),
		new ConstantFolding.Compare64x32GreaterOrEqualThanMax(),
		new ConstantFolding.Compare64x32GreaterOrEqualThanMax_v1(),
		new ConstantFolding.Compare64x64GreaterOrEqualThanMax(),
		new ConstantFolding.Compare64x64GreaterOrEqualThanMax_v1(),
		new ConstantFolding.Compare32x32LessThanMax(),
		new ConstantFolding.Compare32x32LessThanMax_v1(),
		new ConstantFolding.Compare32x64LessThanMax(),
		new ConstantFolding.Compare32x64LessThanMax_v1(),
		new ConstantFolding.Compare64x32LessThanMax(),
		new ConstantFolding.Compare64x32LessThanMax_v1(),
		new ConstantFolding.Compare64x64LessThanMax(),
		new ConstantFolding.Compare64x64LessThanMax_v1(),
		new ConstantFolding.Compare32x32LessThanOrEqualMax(),
		new ConstantFolding.Compare32x32LessThanOrEqualMax_v1(),
		new ConstantFolding.Compare32x64LessThanOrEqualMax(),
		new ConstantFolding.Compare32x64LessThanOrEqualMax_v1(),
		new ConstantFolding.Compare64x32LessThanOrEqualMax(),
		new ConstantFolding.Compare64x32LessThanOrEqualMax_v1(),
		new ConstantFolding.Compare64x64LessThanOrEqualMax(),
		new ConstantFolding.Compare64x64LessThanOrEqualMax_v1(),
		new ConstantFolding.Truncate64x32(),
		new ConstantFolding.Neg32(),
		new ConstantFolding.Neg64(),
		new ConstantMove.Add32(),
		new ConstantMove.Add64(),
		new ConstantMove.AddR4(),
		new ConstantMove.AddR8(),
		new ConstantMove.AddManagedPointer(),
		...
		new ConstantMove.Sub32ToAdd(),
		new ConstantMove.Sub64ToAdd(),
		new Simplification.Move32Coalescing(),
		new Simplification.Move64Coalescing(),
		new Simplification.MoveObjectCoalescing(),
		new Simplification.MoveManagedPointerCoalescing(),
		...
		new Simplification.CompareManagedPointerSameAndEqual(),
		new Simplification.CompareObjectSameAndNotEqual(),
		new Simplification.CompareManagedPointerSameAndNotEqual(),
		...
		new Simplification.Compare32x32SwapToZero_v2(),
		new Simplification.Compare32x32SwapToZero_v3(),
		new Simplification.Compare32x64SwapToZero(),
		new Simplification.Compare32x64SwapToZero_v1(),
		new Simplification.Compare32x64SwapToZero_v2(),
		new Simplification.Compare32x64SwapToZero_v3(),
		new Simplification.Compare64x32SwapToZero(),
		new Simplification.Compare64x32SwapToZero_v1(),
		new Simplification.Compare64x32SwapToZero_v2(),
		new Simplification.Compare64x32SwapToZero_v3(),
		new Simplification.Compare64x64SwapToZero(),
		new Simplification.Compare64x64SwapToZero_v1(),
		new Simplification.Compare64x64SwapToZero_v2(),
		new Simplification.Compare64x64SwapToZero_v3(),
		new Simplification.Compare32x32PassThru(),
		new Simplification.Compare32x32PassThru_v1(),
		new Simplification.Compare32x32PassThru_v2(),
		new Simplification.Compare32x32PassThru_v3(),
		new Simplification.Compare32x64PassThru(),
		new Simplification.Compare32x64PassThru_v1(),
		new Simplification.Compare32x64PassThru_v2(),
		new Simplification.Compare32x64PassThru_v3(),
		new Simplification.Compare64x32PassThru(),
		new Simplification.Compare64x32PassThru_v1(),
		new Simplification.Compare64x32PassThru_v2(),
		new Simplification.Compare64x32PassThru_v3(),
		new Simplification.Compare64x64PassThru(),
		new Simplification.Compare64x64PassThru_v1(),
		new Simplification.Compare64x64PassThru_v2(),
		new Simplification.Compare64x64PassThru_v3(),
		new Simplification.Compare32x32NotPassThru(),
		new Simplification.Compare32x32NotPassThru_v1(),
		new Simplification.Compare32x32NotPassThru_v2(),
		new Simplification.Compare32x32NotPassThru_v3(),
		new Simplification.Compare32x64NotPassThru(),
		new Simplification.Compare32x64NotPassThru_v1(),
		new Simplification.Compare32x64NotPassThru_v2(),
		new Simplification.Compare32x64NotPassThru_v3(),
		new Simplification.Compare64x32NotPassThru(),
		new Simplification.Compare64x32NotPassThru_v1(),
		new Simplification.Compare64x32NotPassThru_v2(),
		new Simplification.Compare64x32NotPassThru_v3(),
		new Simplification.Compare64x64NotPassThru(),
		new Simplification.Compare64x64NotPassThru_v1(),
		new Simplification.Compare64x64NotPassThru_v2(),
		new Simplification.Compare64x64NotPassThru_v3(),
		new Simplification.Compare32x32PassThru2(),
		new Simplification.Compare32x32PassThru2_v1(),
		new Simplification.Compare32x32PassThru2_v2(),
		new Simplification.Compare32x32PassThru2_v3(),
		new Simplification.Compare32x64PassThru2(),
		new Simplification.Compare32x64PassThru2_v1(),
		new Simplification.Compare32x64PassThru2_v2(),
		new Simplification.Compare32x64PassThru2_v3(),
		new Simplification.Compare64x32PassThru2(),
		new Simplification.Compare64x32PassThru2_v1(),
		new Simplification.Compare64x32PassThru2_v2(),
		new Simplification.Compare64x32PassThru2_v3(),
		new Simplification.Compare64x64PassThru2(),
		new Simplification.Compare64x64PassThru2_v1(),
		new Simplification.Compare64x64PassThru2_v2(),
		new Simplification.Compare64x64PassThru2_v3(),
		new Simplification.Or32And32And32ByConstant(),
		new Simplification.Or32And32And32ByConstant_v1(),
		new Simplification.Or32And32And32ByConstant_v2(),
		new Simplification.Or32And32And32ByConstant_v3(),
		new Simplification.Or32And32And32ByConstant_v4(),
		new Simplification.Or32And32And32ByConstant_v5(),
		new Simplification.Or32And32And32ByConstant_v6(),
		new Simplification.Or32And32And32ByConstant_v7(),
		new Simplification.Or64And64And64ByConstant(),
		new Simplification.Or64And64And64ByConstant_v1(),
		new Simplification.Or64And64And64ByConstant_v2(),
		new Simplification.Or64And64And64ByConstant_v3(),
		new Simplification.Or64And64And64ByConstant_v4(),
		new Simplification.Or64And64And64ByConstant_v5(),
		new Simplification.Or64And64And64ByConstant_v6(),
		new Simplification.Or64And64And64ByConstant_v7(),
		new Simplification.Or32SignExtend16x32SignExtend16x32(),
		...
		new Simplification.Xor32Max(),
		new Simplification.Xor32Max_v1(),
		new Simplification.Xor64Max(),
		new Simplification.Xor64Max_v1(),
		new Simplification.Neg32Double(),
		new Simplification.Neg64Double(),
		new Simplification.AddCarryOut32CarryNotUsed(),
		new Simplification.AddCarryOut64CarryNotUsed(),
		new Simplification.AddOverflowOut32OverflowNotUsed(),
		new Simplification.AddOverflowOut64OverflowNotUsed(),
		new Simplification.SubCarryOut32CarryNotUsed(),
		new Simplification.SubCarryOut64CarryNotUsed(),
		new Simplification.SubOverflowOut32CarryNotUsed(),
		new Simplification.SubOverflowOut64CarryNotUsed(),
		new Simplification.MulCarryOut32CarryNotUsed(),
		new Simplification.MulCarryOut64CarryNotUsed(),
		new Simplification.MulOverflowOut32CarryNotUsed(),
		new Simplification.MulOverflowOut64CarryNotUsed(),
		...
		new StrengthReduction.AddManagedPointerZero(),
		new StrengthReduction.AddManagedPointerZero_v1(),
		...
		new StrengthReduction.ArithShiftRight32ZeroValue(),
		new StrengthReduction.ArithShiftRight64ZeroValue(),
		new StrengthReduction.ArithShiftRight32ByZero(),
		new StrengthReduction.ArithShiftRight64ByZero(),
		...
		new StrengthReduction.SubManagedPointerByZero(),
		new StrengthReduction.SubManagedPointerSame(),
		...
		new StrengthReduction.MulSigned32ByNegative1(),
		new StrengthReduction.MulSigned32ByNegative1_v1(),
		new StrengthReduction.MulSigned64ByNegative1(),
		new StrengthReduction.MulSigned64ByNegative1_v1(),
		...
		new StrengthReduction.Xor32Xor32(),
		new StrengthReduction.Xor32Xor32_v1(),
		new StrengthReduction.Xor32Xor32_v2(),
		new StrengthReduction.Xor32Xor32_v3(),
		new StrengthReduction.Xor64Xor64(),
		...
		new StrengthReduction.ShiftRight32By32(),
		new StrengthReduction.ShiftLeft64By64(),
		new StrengthReduction.ShiftRight64By64(),
		new StrengthReduction.MulHu32ByZero(),
		new StrengthReduction.MulHu32ByZero_v1(),
		new StrengthReduction.AddCarryOut32ByZero(),
		new StrengthReduction.AddCarryOut32ByZero_v1(),
		new StrengthReduction.AddCarryOut64ByZero(),
		new StrengthReduction.AddCarryOut64ByZero_v1(),
		...
		new StrengthReduction.RemSigned32ByNegative1(),
		new StrengthReduction.RemSigned64ByNegative1(),
		new StrengthReduction.And32And32Consecutive(),
		new StrengthReduction.And32And32Consecutive_v1(),
		new StrengthReduction.And32And32Consecutive_v2(),
		new StrengthReduction.And32And32Consecutive_v3(),
		new StrengthReduction.And64And64Consecutive(),
		new StrengthReduction.And64And64Consecutive_v1(),
		new StrengthReduction.And64And64Consecutive_v2(),
		new StrengthReduction.And64And64Consecutive_v3(),
		...
		new StrengthReduction.IsolateAndFlipLeastSignificantBit32(),
		new StrengthReduction.IsolateAndFlipLeastSignificantBit32_v1(),
		new StrengthReduction.Or32Xor32(),
		new StrengthReduction.Or32Xor32_v1(),
		new StrengthReduction.Or32Xor32_v2(),
		new StrengthReduction.Or32Xor32_v3(),
		new StrengthReduction.Or64Xor64(),
		...
		new Rewrite.CompareManagedPointerGreaterThanZero(),
		new Rewrite.CompareManagedPointerGreaterThanZero_v1(),
		...
		new Rewrite.CompareObjectLessThanZero(),
		new Rewrite.CompareObjectLessThanZero_v1(),
		new Rewrite.CompareManagedPointerLessThanZero(),
		new Rewrite.CompareManagedPointerLessThanZero_v1(),
		new Rewrite.IfThenElse32Compare32(),
		new Rewrite.IfThenElse32Compare32_v1(),
		new Rewrite.IfThenElse64Compare64(),
		new Rewrite.IfThenElse64Compare64_v1(),
		new Rewrite.DivSigned32ToUnsignedDivide(),
		...
		new BitValue.Compare32x32EqualAdd32_v1(),
		new BitValue.Compare64x32EqualAdd64(),
		new BitValue.Compare64x32EqualAdd64_v1(),
		new BitValue.Compare32x64EqualAdd32(),
		new BitValue.Compare32x64EqualAdd32_v1(),
		new BitValue.Compare64x64EqualAdd64(),
		new BitValue.Compare64x64EqualAdd64_v1(),
