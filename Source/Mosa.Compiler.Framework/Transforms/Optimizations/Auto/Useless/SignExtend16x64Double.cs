...
{
	public static readonly SignExtend16x64Double Instance = new();

	private SignExtend16x64Double() : base(IR.SignExtend16x64, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
