...
{
	public static readonly ZeroExtend8x32ZeroExtend16x32 Instance = new();

	private ZeroExtend8x32ZeroExtend16x32() : base(IR.ZeroExtend8x32, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
