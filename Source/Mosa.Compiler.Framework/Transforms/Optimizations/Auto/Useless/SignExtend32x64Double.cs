...
{
	public static readonly SignExtend32x64Double Instance = new();

	private SignExtend32x64Double() : base(IR.SignExtend32x64, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
