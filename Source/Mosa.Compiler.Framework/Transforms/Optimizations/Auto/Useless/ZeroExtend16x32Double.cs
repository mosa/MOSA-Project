...
{
	public static readonly ZeroExtend16x32Double Instance = new();

	private ZeroExtend16x32Double() : base(IR.ZeroExtend16x32, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
