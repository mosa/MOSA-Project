...
{
	public static readonly ZeroExtend16x64ZeroExtend32x64 Instance = new();

	private ZeroExtend16x64ZeroExtend32x64() : base(IR.ZeroExtend16x64, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
