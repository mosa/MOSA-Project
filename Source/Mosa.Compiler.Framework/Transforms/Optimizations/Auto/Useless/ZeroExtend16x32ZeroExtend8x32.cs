...
{
	public static readonly ZeroExtend16x32ZeroExtend8x32 Instance = new();

	private ZeroExtend16x32ZeroExtend8x32() : base(IR.ZeroExtend16x32, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
