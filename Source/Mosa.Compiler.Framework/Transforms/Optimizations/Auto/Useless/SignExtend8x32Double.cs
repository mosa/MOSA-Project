...
{
	public static readonly SignExtend8x32Double Instance = new();

	private SignExtend8x32Double() : base(IR.SignExtend8x32, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
