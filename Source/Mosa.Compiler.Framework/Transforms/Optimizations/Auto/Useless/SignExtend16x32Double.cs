...
{
	public static readonly SignExtend16x32Double Instance = new();

	private SignExtend16x32Double() : base(IR.SignExtend16x32, TransformType.Auto | TransformType.Optimization, 85)
	{
	}
