...
{
	public static readonly MulUnsigned64WithShiftLeft64 Instance = new();

	private MulUnsigned64WithShiftLeft64() : base(IR.MulUnsigned64, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly MulUnsigned64WithShiftLeft64_v1 Instance = new();

	private MulUnsigned64WithShiftLeft64_v1() : base(IR.MulUnsigned64, TransformType.Auto | TransformType.Optimization)
	{
	}
