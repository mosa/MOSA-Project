...
{
	public static readonly PhiManagedPointerUpdate Instance = new();

	private PhiManagedPointerUpdate() : base(IR.PhiManagedPointer, TransformType.Manual | TransformType.Optimization)
	{
	}
