...
{
	public PhiManagedPointerBranchHoisting() : base(Framework.IR.PhiManagedPointer, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (ctx.Instruction != Framework.IR.BranchManagedPointer)
			return false;
