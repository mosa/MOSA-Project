...
{
	public StoreLoadManagedPointer() : base(Framework.IR.StoreManagedPointer, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.MoveManagedPointer, load.Result, context.Operand3);
		load.SetNop();
	}
}
