...
{
	public sealed class Move64Propagate : BaseTransformation
	{
		public Move64Propagate() : base(IRInstruction.Move64, TransformationType.Manual | TransformationType.Optimization)
		{
		}
