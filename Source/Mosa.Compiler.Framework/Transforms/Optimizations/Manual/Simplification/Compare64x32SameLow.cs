...
{
	public static readonly Compare64x32SameLow Instance = new();

	private Compare64x32SameLow() : base(IR.Compare64x32, TransformType.Manual | TransformType.Optimization)
	{
	}
