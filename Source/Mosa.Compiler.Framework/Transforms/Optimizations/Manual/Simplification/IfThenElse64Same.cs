...
{
	public IfThenElse64Same() : base(Framework.IR.IfThenElse64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	{
		context.SetInstruction(Framework.IR.Move64, context.Result, context.Operand1);
	}
}
