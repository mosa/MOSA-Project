...
{
	public static readonly Compare32x64BitValue Instance = new();

	private Compare32x64BitValue() : base(IR.Compare32x64, TransformType.Manual | TransformType.Optimization, 35)
	{
	}
