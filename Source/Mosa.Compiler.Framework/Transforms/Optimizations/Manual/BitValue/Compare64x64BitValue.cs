...
{
	public static readonly Compare64x64BitValue Instance = new();

	private Compare64x64BitValue() : base(IR.Compare64x64, TransformType.Manual | TransformType.Optimization, 35)
	{
	}
