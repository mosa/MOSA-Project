...
{
	public static readonly Compare32x32BitValue Instance = new();

	private Compare32x32BitValue() : base(IR.Compare32x32, TransformType.Manual | TransformType.Optimization, 35)
	{
	}
