...
public sealed class Branch64 : BaseTransform
{
	...
	{
		context.SetInstruction(Framework.IR.Branch64, context.ConditionCode.GetReverse(), context.Result, context.Operand2, context.Operand1, context.BranchTargets[0]);
	}
}
