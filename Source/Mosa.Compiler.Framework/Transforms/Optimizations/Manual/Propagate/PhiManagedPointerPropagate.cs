...
{
	public static readonly PhiManagedPointerPropagate Instance = new();

	private PhiManagedPointerPropagate() : base(IR.PhiManagedPointer, TransformType.Manual | TransformType.Optimization, 40)
	{
	}
