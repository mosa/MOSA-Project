...
{
	public static readonly Move32PropagateConstant Instance = new();

	private Move32PropagateConstant() : base(IR.Move32, TransformType.Manual | TransformType.Optimization, 40)
	{
	}
