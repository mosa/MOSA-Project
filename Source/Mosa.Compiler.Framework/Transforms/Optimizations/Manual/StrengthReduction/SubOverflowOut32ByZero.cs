...
{
	public SubOverflowOut32ByZero() : base(Framework.IR.SubOverflowOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
...
{
	public SubOverflowOut32ByZero2() : base(Framework.IR.SubOverflowOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
