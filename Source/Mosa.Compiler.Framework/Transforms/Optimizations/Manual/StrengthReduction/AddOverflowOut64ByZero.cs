...
{
	public AddOverflowOut64ByZero() : base(IR.AddOverflowOut64, TransformType.Manual | TransformType.Optimization, true)
	{
	}
...
{
	public AddOverflowOut64ByZero2() : base(IR.AddOverflowOut64, TransformType.Manual | TransformType.Optimization, true)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(IR.Move64, result, operand2);
		context.AppendInstruction(IR.Move64, result2, Operand.Constant64_0);
	}
}
