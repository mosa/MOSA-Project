...
{
	public AddOverflowOut32ByZero() : base(Framework.IR.AddOverflowOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
...
{
	public AddOverflowOut32ByZero2() : base(Framework.IR.AddOverflowOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Move32, result, operand2);
		context.AppendInstruction(Framework.IR.Move32, result2, Operand.Constant32_0);
	}
}
