...
{
	public AddOverflowOut32ByZero() : base(IR.AddOverflowOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
...
{
	public AddOverflowOut32ByZero2() : base(IR.AddOverflowOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
