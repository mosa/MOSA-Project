...
/// <summary>
/// SubCarryOut32ByZero2
/// </summary>
public sealed class SubCarryOut32ByZero2 : BaseTransform
{
	public SubCarryOut32ByZero2() : base(IRInstruction.SubCarryOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
