...
{
	public AddCarryOut64ByZero() : base(IR.AddCarryOut64, TransformType.Manual | TransformType.Optimization, true)
	{
	}
...
{
	public AddCarryOut64ByZero2() : base(IR.AddCarryOut64, TransformType.Manual | TransformType.Optimization, true)
	{
	}
