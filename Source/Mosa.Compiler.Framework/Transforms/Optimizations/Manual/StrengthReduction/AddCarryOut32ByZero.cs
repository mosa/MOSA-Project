...
{
	public AddCarryOut32ByZero() : base(IR.AddCarryOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
...
{
	public AddCarryOut32ByZero2() : base(IR.AddCarryOut32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
