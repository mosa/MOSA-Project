...
/// </summary>
public sealed class SubCarryOut64ByZero2 : BaseTransform
{
	public SubCarryOut64ByZero2() : base(IRInstruction.SubCarryOut64, TransformType.Manual | TransformType.Optimization, true)
	{
	}
