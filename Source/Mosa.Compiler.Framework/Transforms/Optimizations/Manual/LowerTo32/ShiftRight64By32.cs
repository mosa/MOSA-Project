...
{
	public sealed class ShiftRight64By32 : BaseTransform
	{
		public ShiftRight64By32() : base(IRInstruction.ShiftRight64, TransformType.Manual | TransformType.Optimization)
		{
		}
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			context.AppendInstruction(IRInstruction.To64, result, v1, transform.Constant32_0);
		}
	}
}
