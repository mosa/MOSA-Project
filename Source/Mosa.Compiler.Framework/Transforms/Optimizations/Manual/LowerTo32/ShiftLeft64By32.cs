...
{
	public sealed class ShiftLeft64By32 : BaseTransform
	{
		public ShiftLeft64By32() : base(IRInstruction.ShiftLeft64, TransformType.Manual | TransformType.Optimization)
		{
		}
		...
		public override void Transform(Context context, TransformContext transform)
		{
			...
			context.AppendInstruction(IRInstruction.To64, result, transform.Constant32_0, v1);
		}
	}
}
