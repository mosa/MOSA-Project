...
{
	public LoadParamSignExtend16x64Store16() : base(Framework.IR.LoadParamSignExtend16x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.SignExtend16x64, context.Result, previous.Operand2);
	}
}
