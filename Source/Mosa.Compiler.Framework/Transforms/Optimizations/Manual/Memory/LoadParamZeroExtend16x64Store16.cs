...
{
	public static readonly LoadParamZeroExtend16x64Store16 Instance = new();

	private LoadParamZeroExtend16x64Store16() : base(IR.LoadParamZeroExtend16x64, TransformType.Manual | TransformType.Optimization)
	{
	}
