...
public sealed class LoadStoreR8 : BaseTransform
{
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		var previous = GetPreviousNodeUntil(context, IR.StoreR8, transform.Window, out var immediate, context.Operand1);
	...
	{
		var previous = GetPreviousNodeUntil(context, IR.StoreR8, transform.Window, context.Operand1);
