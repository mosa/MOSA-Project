...
{
	public LoadParamSignExtend8x64Store8() : base(Framework.IR.LoadParamSignExtend8x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.SignExtend8x64, context.Result, previous.Operand2);
	}
}
