...
{
	public LoadParamSignExtend16x32Store16() : base(Framework.IR.LoadParamSignExtend16x32, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.SignExtend16x32, context.Result, previous.Operand2);
	}
}
