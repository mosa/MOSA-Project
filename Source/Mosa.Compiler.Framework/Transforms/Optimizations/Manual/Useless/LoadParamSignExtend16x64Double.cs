...
{
	public static readonly LoadParamSignExtend16x64Double Instance = new();

	private LoadParamSignExtend16x64Double() : base(IR.SignExtend16x64, TransformType.Manual | TransformType.Optimization, 85)
	{
	}
