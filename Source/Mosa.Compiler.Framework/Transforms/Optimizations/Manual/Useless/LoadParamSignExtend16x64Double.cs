...
{
	public LoadParamSignExtend16x64Double() : base(Framework.IR.SignExtend16x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Instruction != Framework.IR.LoadParamSignExtend16x64)
			return false;
