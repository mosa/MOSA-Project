...
{
	public static readonly LoadParamZeroExtend8x32Double Instance = new();

	private LoadParamZeroExtend8x32Double() : base(IR.ZeroExtend8x32, TransformType.Manual | TransformType.Optimization, 85)
	{
	}
