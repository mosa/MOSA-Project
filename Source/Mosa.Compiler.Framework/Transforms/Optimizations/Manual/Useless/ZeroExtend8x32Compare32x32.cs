...
{
	public static readonly ZeroExtend8x32Compare32x32 Instance = new();

	private ZeroExtend8x32Compare32x32() : base(IR.ZeroExtend8x32, TransformType.Manual | TransformType.Optimization, 85)
	{
	}
