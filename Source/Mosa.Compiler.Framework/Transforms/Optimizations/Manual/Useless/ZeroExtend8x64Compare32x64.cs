...
{
	public static readonly ZeroExtend8x64Compare32x64 Instance = new();

	private ZeroExtend8x64Compare32x64() : base(IR.ZeroExtend8x64, TransformType.Manual | TransformType.Optimization, 85)
	{
	}
