...
{
	public LoadParamZeroExtend8x64Double() : base(Framework.IR.ZeroExtend8x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Instruction != Framework.IR.LoadParamZeroExtend8x64)
			return false;
