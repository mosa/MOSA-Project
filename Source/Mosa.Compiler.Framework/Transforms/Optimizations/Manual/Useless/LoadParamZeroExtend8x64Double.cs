...
{
	public LoadParamZeroExtend8x64Double() : base(IRInstruction.ZeroExtend8x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, TransformContext transform)
	{
		...
		if (context.Operand1.Definitions[0].Instruction != IRInstruction.LoadParamZeroExtend8x64)
			return false;
