...
{
	public static readonly LoadParamZeroExtend8x64Double Instance = new();

	private LoadParamZeroExtend8x64Double() : base(IR.ZeroExtend8x64, TransformType.Manual | TransformType.Optimization, 85)
	{
	}
