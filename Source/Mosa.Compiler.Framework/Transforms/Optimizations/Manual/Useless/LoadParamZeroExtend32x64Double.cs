...
{
	public static readonly LoadParamZeroExtend32x64Double Instance = new();

	private LoadParamZeroExtend32x64Double() : base(IR.ZeroExtend32x64, TransformType.Manual | TransformType.Optimization, 85)
	{
	}
