...
{
	public LoadParamZeroExtend32x64Double() : base(IRInstruction.ZeroExtend32x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, TransformContext transform)
	{
		...
		if (context.Operand1.Definitions[0].Instruction != IRInstruction.LoadParamZeroExtend32x64)
			return false;
