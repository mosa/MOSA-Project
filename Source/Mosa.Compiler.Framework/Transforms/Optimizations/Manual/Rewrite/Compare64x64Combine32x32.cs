...
{
	public Compare64x64Combine32x32() : base(Framework.IR.Compare64x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Compare32x64, conditionCode, context.Result, node2.Operand1, node2.Operand2);
	}
}
