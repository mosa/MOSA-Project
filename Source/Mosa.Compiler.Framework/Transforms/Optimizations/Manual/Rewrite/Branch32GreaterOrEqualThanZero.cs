...
{
	public static readonly Branch32GreaterOrEqualThanZero Instance = new();

	private Branch32GreaterOrEqualThanZero() : base(IR.Branch32, TransformType.Manual | TransformType.Optimization)
	{
	}
