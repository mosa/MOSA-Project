...
{
	public static readonly Compare64x32ZeroExtend Instance = new();

	private Compare64x32ZeroExtend() : base(IR.Compare64x32, TransformType.Manual | TransformType.Optimization)
	{
	}
