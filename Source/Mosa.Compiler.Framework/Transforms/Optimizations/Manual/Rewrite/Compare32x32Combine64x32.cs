...
{
	public sealed class Compare32x32Combine64x32 : BaseTransformation
	{
		public Compare32x32Combine64x32() : base(IRInstruction.Compare32x32, TransformationType.Manual | TransformationType.Optimization)
		{
		}
