...
{
	public static readonly Compare32x32Combine64x32 Instance = new();

	private Compare32x32Combine64x32() : base(IR.Compare32x32, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand1.Definitions[0].Instruction != IR.Compare64x32)
			return false;
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(IR.Compare64x32, conditionCode, context.Result, node2.Operand1, node2.Operand2);
	}
}
