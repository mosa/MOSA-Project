...
public sealed class Branch32Object : BaseTransform
{
	public static readonly Branch32Object Instance = new();

	private Branch32Object() : base(IR.Branch32, TransformType.Manual | TransformType.Optimization)
	{
	}
