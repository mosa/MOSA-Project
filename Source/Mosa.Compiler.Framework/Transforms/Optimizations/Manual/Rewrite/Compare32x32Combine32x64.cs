...
{
	public static readonly Compare32x32Combine32x64 Instance = new();

	private Compare32x32Combine32x64() : base(IR.Compare32x32, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(IR.Compare32x32, conditionCode, context.Result, node2.Operand1, node2.Operand2);
	}
}
