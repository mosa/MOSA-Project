...
public sealed class Branch64Combine32x64 : BaseTransform
{
	public Branch64Combine32x64() : base(Framework.IR.Branch64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Branch32, conditionCode, null, node2.Operand1, node2.Operand2, context.BranchTargets[0]);
	}
}
