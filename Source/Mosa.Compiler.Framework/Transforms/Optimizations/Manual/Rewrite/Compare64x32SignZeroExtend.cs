...
{
	public static readonly Compare64x32SignZeroExtend Instance = new();

	private Compare64x32SignZeroExtend() : base(IR.Compare64x32, TransformType.Manual | TransformType.Optimization)
	{
	}
