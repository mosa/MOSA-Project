...
{
	public static readonly Branch32ManagedPointer Instance = new();

	private Branch32ManagedPointer() : base(IR.Branch32, TransformType.Manual | TransformType.Optimization)
	{
	}
