...
{
	public static readonly Compare64x64Combine64x64 Instance = new();

	private Compare64x64Combine64x64() : base(IR.Compare64x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(IR.Compare64x64, conditionCode, context.Result, node2.Operand1, node2.Operand2);
	}
}
