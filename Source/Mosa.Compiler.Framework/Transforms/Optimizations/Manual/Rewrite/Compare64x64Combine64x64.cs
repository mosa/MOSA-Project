...
{
	public Compare64x64Combine64x64() : base(Framework.IR.Compare64x64, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(Framework.IR.Compare64x64, conditionCode, context.Result, node2.Operand1, node2.Operand2);
	}
}
