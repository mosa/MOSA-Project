...
public sealed class Branch64Combine64x32 : BaseTransform
{
	public static readonly Branch64Combine64x32 Instance = new();

	private Branch64Combine64x32() : base(IR.Branch64, TransformType.Manual | TransformType.Optimization)
	{
	}
