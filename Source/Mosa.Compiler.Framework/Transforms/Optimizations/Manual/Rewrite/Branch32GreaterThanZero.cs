...
{
	public static readonly Branch32GreaterThanZero Instance = new();

	private Branch32GreaterThanZero() : base(IR.Branch32, TransformType.Manual | TransformType.Optimization)
	{
	}
