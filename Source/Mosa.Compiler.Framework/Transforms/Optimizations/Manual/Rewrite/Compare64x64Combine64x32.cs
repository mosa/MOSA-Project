...
{
	public static readonly Compare64x64Combine64x32 Instance = new();

	private Compare64x64Combine64x32() : base(IR.Compare64x64, TransformType.Manual | TransformType.Optimization)
	{
	}
