...
{
	public static readonly Branch64LessOrEqualThanZero Instance = new();

	private Branch64LessOrEqualThanZero() : base(IR.Branch64, TransformType.Manual | TransformType.Optimization)
	{
	}
