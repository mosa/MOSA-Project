...
public sealed class Branch64Combine64x64 : BaseTransform
{
	public static readonly Branch64Combine64x64 Instance = new();

	private Branch64Combine64x64() : base(IR.Branch64, TransformType.Manual | TransformType.Optimization)
	{
	}
