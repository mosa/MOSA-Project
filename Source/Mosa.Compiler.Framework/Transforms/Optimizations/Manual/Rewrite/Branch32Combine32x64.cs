...
public sealed class Branch32Combine32x64 : BaseTransform
{
	public Branch32Combine32x64() : base(Framework.IR.Branch32, TransformType.Manual | TransformType.Optimization)
	{
	}
