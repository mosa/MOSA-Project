...
{
	public static readonly Compare64x32SignExtended Instance = new();

	private Compare64x32SignExtended() : base(IR.Compare64x32, TransformType.Manual | TransformType.Optimization)
	{
	}
	...
	public override bool Match(Context context, Transform transform)
	{
		...
		if (context.Operand2.Definitions[0].Instruction != IR.SignExtend32x64)
			return false;
