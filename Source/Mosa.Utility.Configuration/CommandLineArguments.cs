...
public static class CommandLineArguments
{
	...
	private static List<Argument> GetMap()
	{
		var map = new List<Argument>
		{
			...
			new Argument { Name = "-bisect", Setting = Name.UnitTest_Bisector_Plan, Value = "disable-one"},
			...
			new Argument { Name = "-bisect-seed", Setting = Name.UnitTest_Bisector_RandomSeed},
			new Argument { Name = "-bisect-reset", Setting = Name.UnitTest_Bisector_ResetState, Value = "true"},
			new Argument { Name = "-bisect-worker-iteration", Setting = Name.UnitTest_Bisector_WorkerIteration, Value = "true"},
			...
			new Argument { Name = "-o0", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o1", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o2", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o3", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o4", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o5", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o6", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o7", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o8", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-o9", Setting = Name.Optimizations_LoopRangeTracker, Value = "true"},
			...
			new Argument { Name = "-oNone", Setting = Name.Optimizations_LoopRangeTracker, Value = "false"},
			...
			new Argument { Name = "-oMax", Setting = Name.Optimizations_LoopRangeTracker, Value = "true"},
