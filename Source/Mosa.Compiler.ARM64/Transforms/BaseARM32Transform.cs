...
namespace Mosa.Compiler.ARM64.Transforms
{
	public abstract class BaseARM32Transform : BaseTransform
	{
		...
		public static void ExpandMul(Transform transform, Context context)
		{
			...
			//context.SetInstruction2(ARM64.UMull, v1, resultLow, op1L, op2L); // TODO
			//context.AppendInstruction(ARM64.Mla, v2, op1L, op2H, v1); // TODO
			//context.AppendInstruction(ARM64.Mla, resultHigh, op1H, op2L, v2); // TODO
		}
		...
		public static Operand MoveConstantToRegisterOrImmediate(Transform transform, Context context, Operand operand, bool allowImmediate)
		{
			...
			if (operand.IsResolvedConstant)
			{
				if (ARMHelper.CalculateRotatedImmediateValue(operand.ConstantUnsigned32, out uint immediate, out byte _, out byte _))
				{
					...
					var v1 = transform.VirtualRegisters.Allocate32();
					//before.SetInstruction(ARM64.Mov, v1, constant); // TODO
...

				{
					...
					var v1 = transform.VirtualRegisters.Allocate32();
					//before.SetInstruction(ARM64.Movw, v1, Operand.CreateConstant32(operand.ConstantUnsigned32 & 0xFFFF)); // TODO
					//before.AppendInstruction(ARM64.Movt, v1, v1, Operand.CreateConstant32(operand.ConstantUnsigned32 >> 16)); // TODO
			...
			else if (operand.IsUnresolvedConstant)
			{
				var before = context.InsertBefore();
				var v1 = transform.VirtualRegisters.Allocate32();
				//before.SetInstruction(ARM64.Movw, v1, operand); // TODO
				//before.AppendInstruction(ARM64.Movt, v1, v1, operand); // TODO
		...
		public static Operand MoveConstantToFloatRegisterOrImmediate(Transform transform, Context context, Operand operand, bool allowImmediate)
		{
			...
			//context.InsertBefore().SetInstruction(ARM64.Ldf, v1, label, Operand.Constant32_0); // TODO
