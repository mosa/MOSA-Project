...
{
	public class WhileFixture : X86TestFixture
	{
		...
		{
			Assert.Equal<int>(WhileTests.WhileIncI4(start, limit), Run<int>("Mosa.Test.Collection.WhileTests.WhileIncI4", start, limit));
		}
		...
		{
			Assert.Equal<int>(WhileTests.WhileDecI4(start, limit), Run<int>("Mosa.Test.Collection.WhileTests.WhileDecI4", start, limit));
		}
		...
		{
			Assert.Equal<int>(WhileTests.WhileOverflowIncI1(start, limit), Run<int>("Mosa.Test.Collection.WhileTests.WhileOverflowIncI1", start, limit));
		}
		...
		{
			Assert.Equal<int>(WhileTests.WhileOverflowDecI1(start, limit), Run<int>("Mosa.Test.Collection.WhileTests.WhileOverflowDecI1", start, limit));
		}
		...
		{
			Assert.Equal<int>(WhileTests.WhileNestedEqualsI4(a, b, start, limit), Run<int>("Mosa.Test.Collection.WhileTests.WhileNestedEqualsI4", a, b, start, limit));
		}
