...
{
	public class UInt8Fixture : X86TestFixture
	{
		[Theory]
		...
		{
			Assert.Equal(UInt8Tests.DivU1U1(a, 0), Run<int>("Mosa.Test.Collection.UInt8Tests.DivU1U1", a, (byte)0));
		}
		...
		{
			Assert.Equal(UInt8Tests.RemU1U1(a, 0), Run<int>("Mosa.Test.Collection.UInt8Tests.RemU1U1", a, (byte)0));
		}
		...
		{
			Assert.Equal(UInt8Tests.Ldelem(index, value), Run<byte>("Mosa.Test.Collection.UInt8Tests.Ldelem", index, value));
		}
		...
		{
			Assert.Equal(UInt8Tests.Ldelema(index, value), Run<byte>("Mosa.Test.Collection.UInt8Tests.Ldelema", index, value));
		}
	}
}
