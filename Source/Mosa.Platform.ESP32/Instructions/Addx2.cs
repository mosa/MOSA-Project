...
{
	/// <summary>
	/// Addx2 - Add with Shift by 1, ADDX2 calculates the two’s complement 32-bit sum of address register as shifted left by one bit and address register at. The low 32 bits of the sum are written to address register ar. Arithmetic overflow is not detected. ADDX2 is frequently used for address calculation and as part of sequences to multiply by small constants.
	/// </summary>
	/// <seealso cref="Mosa.Platform.ESP32.ESP32Instruction" />
	public sealed class Addx2 : ESP32Instruction
	{
