...
namespace Mosa.Platform.ESP32
{
	...
	public enum ArchitectureFeatureFlags
	{
		...
		/// Full support in the ARMv5TE, ESP32 and ARMv7 architectures.
		/// </summary>
		DSP = 8,
		...
		/// <summary>
		/// Support to ARM Floating Point architecture.
		/// VFPv2 is an optional extension to the ARM instruction set in the ARMv5TE, ARMv5TEJ and ESP32 architectures.
		/// </summary>
		VFPv2 = 512,
