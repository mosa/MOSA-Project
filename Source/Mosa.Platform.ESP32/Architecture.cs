...
using Mosa.Platform.ESP32.Stages;
...
namespace Mosa.Platform.ESP32
{
	...
	public class Architecture : BaseArchitecture
	{
		...
		/// </summary>
		public override string PlatformName { get { return "ESP32"; } }
		...
		/// <summary>
		/// Retrieves the register set of the ESP32 platform.
		/// </summary>
		...
		/// <summary>
		/// Retrieves the scratch register of the ESP32.
		/// </summary>
		...
		/// The instructions.
		/// </value>
		public override List<BaseInstruction> Instructions { get { return ESP32Instructions.List; } }

		/// <summary>
		/// Extends the compiler pipeline with ESP32 specific stages.
		/// </summary>
		...
		/// <summary>
		/// Extends the method compiler pipeline with ESP32 specific stages.
		/// </summary>
