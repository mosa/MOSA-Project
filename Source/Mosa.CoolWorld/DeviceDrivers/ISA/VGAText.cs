	...
	public class VGAText : HardwareDevice, IDevice, ITextDevice
	{
		...
		{			
			if (colorMode)
			{
				...
				int f = (byte)foreground;
				int b = (byte)background;
				memory[index + 1] = (byte)(f | (b << 4));
			}
			else
			{
		...
		private static byte[] _VGAText80x25;

		private static byte[] GetVGAText80x25()
		{
			if (_VGAText80x25 == null)
			{
				_VGAText80x25 = new byte[12 + 8 * 6];
				int i = 0;

				/* MISC */
				_VGAText80x25[i++] = 0x67;
				/* SEQ */
				_VGAText80x25[i++] = 0x03; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x03; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x02;
				/* CRTC */
				_VGAText80x25[i++] = 0x5F; _VGAText80x25[i++] = 0x4F; _VGAText80x25[i++] = 0x50; _VGAText80x25[i++] = 0x82; _VGAText80x25[i++] = 0x55; _VGAText80x25[i++] = 0x81; _VGAText80x25[i++] = 0xBF; _VGAText80x25[i++] = 0x1F;
				_VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x4F; _VGAText80x25[i++] = 0x0D; _VGAText80x25[i++] = 0x0E; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x50;
				_VGAText80x25[i++] = 0x9C; _VGAText80x25[i++] = 0x0E; _VGAText80x25[i++] = 0x8F; _VGAText80x25[i++] = 0x28; _VGAText80x25[i++] = 0x1F; _VGAText80x25[i++] = 0x96; _VGAText80x25[i++] = 0xB9; _VGAText80x25[i++] = 0xA3;
				_VGAText80x25[i++] = 0xFF;
				/* GC */
				_VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x10; _VGAText80x25[i++] = 0x0E; _VGAText80x25[i++] = 0x00;
				_VGAText80x25[i++] = 0xFF;
				/* AC */
				_VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x01; _VGAText80x25[i++] = 0x02; _VGAText80x25[i++] = 0x03; _VGAText80x25[i++] = 0x04; _VGAText80x25[i++] = 0x05; _VGAText80x25[i++] = 0x14; _VGAText80x25[i++] = 0x07;
				_VGAText80x25[i++] = 0x38; _VGAText80x25[i++] = 0x39; _VGAText80x25[i++] = 0x3A; _VGAText80x25[i++] = 0x3B; _VGAText80x25[i++] = 0x3C; _VGAText80x25[i++] = 0x3D; _VGAText80x25[i++] = 0x3E; _VGAText80x25[i++] = 0x3F;
				_VGAText80x25[i++] = 0x0C; _VGAText80x25[i++] = 0x00; _VGAText80x25[i++] = 0x0F; _VGAText80x25[i++] = 0x08; _VGAText80x25[i++] = 0x00;
			}

			return _VGAText80x25;
		}
