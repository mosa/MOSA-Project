...
namespace System
{
	public sealed unsafe class RuntimeTypeInfo : TypeInfo
	{
		...
		public RuntimeTypeInfo(RuntimeType type, Assembly assembly)
		{
			...
			this.assemblyQualifiedName = Mosa.Runtime.Internal.InitializeMetadataString(this.typeStruct->Name);    // TODO
			this.name = Mosa.Runtime.Internal.InitializeMetadataString(this.typeStruct->Name);                 // TODO
			this.@namespace = Mosa.Runtime.Internal.InitializeMetadataString(this.typeStruct->Name);               // TODO
			this.fullname = Mosa.Runtime.Internal.InitializeMetadataString(this.typeStruct->Name);
