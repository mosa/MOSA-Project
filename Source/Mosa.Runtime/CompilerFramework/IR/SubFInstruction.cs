...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class SubFInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SubFInstruction"/>.
		/// </summary>
		public SubFInstruction()
		{
		}
		...
		{
			visitor.SubFInstruction(context);
		}
		...
		{
			return String.Format(@"IR sub.f{0} {1} = {2} - {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
