...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class DivFInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="DivFInstruction"/>.
		/// </summary>
		public DivFInstruction()
		{
		}
		...
		{
			visitor.DivFInstruction(context);
		}
		...
		{
			return String.Format(@"IR div.f{0} {1} = {2} / {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
