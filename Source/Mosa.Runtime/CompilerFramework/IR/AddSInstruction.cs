...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class AddSInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="AddSInstruction"/>.
		/// </summary>
		...
		{
			visitor.AddSInstruction(context);
		}
		...
		{
			return String.Format(@"IR add.s{0} {1} = {2} + {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
