...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class MulFInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="MulFInstruction"/>.
		/// </summary>
		public MulFInstruction()
		{
		}
		...
		{
			visitor.MulFInstruction(context);
		}
		...
		{
			return String.Format(@"IR mul.f{0} {1} = {2} * {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
