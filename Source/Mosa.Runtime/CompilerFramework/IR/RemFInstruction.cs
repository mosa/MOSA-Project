...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class RemFInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="RemFInstruction"/>.
		/// </summary>
		public RemFInstruction()
		{
		}
		...
		{
			visitor.RemFInstruction(context);
		}
		...
		{
			return String.Format(@"IR rem.f{0} {1} = {2} % {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
