...
namespace Mosa.Compiler.Platform.x64.Intrinsic
{
	...
	{
		[IntrinsicMethod("Mosa.Compiler.Platform.x64.Intrinsic::CpuIdRBX")]
		private static void CpuIdRBX(Context context, MethodCompiler methodCompiler)
		{
			...
			context.AppendInstruction(X64.Mov64, result, rbx);
		}
	}
}
