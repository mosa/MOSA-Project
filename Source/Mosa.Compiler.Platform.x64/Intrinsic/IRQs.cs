...
namespace Mosa.Compiler.Platform.x64.Intrinsic
{
	...
	static partial class IntrinsicMethods
	{
		...
		{
			var interruptMethodName = methodCompiler.Compiler.CompilerSettings.Settings.GetValue("X64.InterruptMethodName", DefaultInterruptMethodName);
