...
namespace Mosa.Tool.Launcher
{
	public partial class Launcher : Form
	{
		...
		private void UpdateSettings()
		{
			...
			Settings.SetValue("Compiler.Multithreading.MaxThreads", txtThreads.Text.ToInt32());
		...
		private void UpdateDisplay()
		{
			...
			txtThreads.Text = Settings.GetValue("Compiler.Multithreading.MaxThreads", Environment.ProcessorCount.ToString());
