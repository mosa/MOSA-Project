...
namespace Mosa.Runtime.CompilerFramework.IR
{
    ...
    /// </remarks>
    public sealed class MulUInstruction : ThreeOperandInstruction
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MulUInstruction"/>.
        /// </summary>
        public MulUInstruction()
        {
        }
        ...
        {
            visitor.MulUInstruction(context);
        }
        ...
        {
            return String.Format(@"IR mul.u{0} {1} = {2} * {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
        }
    }
}
