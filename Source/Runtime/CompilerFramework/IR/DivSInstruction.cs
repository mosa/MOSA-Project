...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class DivSInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="DivSInstruction"/>.
		/// </summary>
		...
		{
			visitor.DivSInstruction(context);
		}
		...
		{
			return String.Format(@"IR div.s{0} {1} = {2} / {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
