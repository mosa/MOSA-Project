...
namespace Mosa.Runtime.CompilerFramework.IR
{
	...
	/// </remarks>
	public sealed class AddFInstruction : ThreeOperandInstruction
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="AddFInstruction"/>.
		/// </summary>
		public AddFInstruction()
		{
		}
		...
		{
			visitor.AddFInstruction(context);
		}
		...
		{
			return String.Format(@"IR add.f{0} {1} = {2} + {3}", context.Result.Precision, context.Result, context.Operand1, context.Operand2);
		}
	}
}
