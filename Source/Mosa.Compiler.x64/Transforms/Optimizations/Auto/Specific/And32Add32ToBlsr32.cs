...
{
	public static readonly And32Add32ToBlsr32 Instance = new();

	private And32Add32ToBlsr32() : base(X64.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly And32Add32ToBlsr32_v1 Instance = new();

	private And32Add32ToBlsr32_v1() : base(X64.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly And32Add32ToBlsr32_v2 Instance = new();

	private And32Add32ToBlsr32_v2() : base(X64.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly And32Add32ToBlsr32_v3 Instance = new();

	private And32Add32ToBlsr32_v3() : base(X64.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
