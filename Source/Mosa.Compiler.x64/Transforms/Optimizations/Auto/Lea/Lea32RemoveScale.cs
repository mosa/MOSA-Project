...
{
	public static readonly Lea32RemoveScale Instance = new();

	private Lea32RemoveScale() : base(X64.Lea32, TransformType.Auto | TransformType.Optimization)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		context.SetInstruction(X64.Lea32, result, t1, e1, e2, t2);
	}
}
