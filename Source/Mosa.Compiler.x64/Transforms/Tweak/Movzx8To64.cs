...
{
	public static readonly Movzx8To64 Instance = new();

	private Movzx8To64() : base(X64.Movzx8To64, TransformType.Manual | TransformType.Transform)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		if (source.Register != result.Register)
		{
			...
			context.AppendInstruction(X64.And64, result, result, Operand.CreateConstant32(0xFF));
		}
		else
		{
			context.SetInstruction(X64.And64, result, result, Operand.CreateConstant32(0xFF));
		}
	}
}
