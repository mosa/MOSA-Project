...
{
	public static readonly Movzx16To32 Instance = new();

	private Movzx16To32() : base(X64.Movzx16To32, TransformType.Manual | TransformType.Transform)
	{
	}
	...
	public override void Transform(Context context, Transform transform)
	{
		...
		if (source.Register != result.Register)
		{
			...
			context.AppendInstruction(X64.And32, result, result, Operand.CreateConstant32(0xFFFF));
		}
		else
		{
			context.SetInstruction(X64.And32, result, result, Operand.CreateConstant32(0xFFFF));
		}
	}
}
