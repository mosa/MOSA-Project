...
{
	public static readonly CompareManagedPointer Instance = new();

	private CompareManagedPointer() : base(IR.CompareManagedPointer, TransformType.Manual | TransformType.Transform)
	{
	}
