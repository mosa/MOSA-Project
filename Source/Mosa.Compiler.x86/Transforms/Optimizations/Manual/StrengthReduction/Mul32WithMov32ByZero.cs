...
{
	public static readonly Mul32WithMov32ByZero Instance = new();

	private Mul32WithMov32ByZero() : base(X86.Mul32, TransformType.Manual | TransformType.Optimization, true)
	{
	}
