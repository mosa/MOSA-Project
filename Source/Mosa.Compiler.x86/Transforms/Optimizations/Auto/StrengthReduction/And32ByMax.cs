...
{
	public And32ByMax() : base(X86.And32, TransformType.Auto | TransformType.Optimization, 75)
	{
	}
...
{
	public And32ByMax_v1() : base(X86.And32, TransformType.Auto | TransformType.Optimization, 75)
	{
	}
