...
{
	public static readonly And32ByZero Instance = new();

	private And32ByZero() : base(X86.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
...
{
	public static readonly And32ByZero_v1 Instance = new();

	private And32ByZero_v1() : base(X86.And32, TransformType.Auto | TransformType.Optimization)
	{
	}
