...
{
	public static readonly ArithShiftRight64Less64 Instance = new();

	private ArithShiftRight64Less64() : base(IR.ArithShiftRight64, TransformType.Manual | TransformType.Transform, 10)
	{
	}
