...
{
	public static readonly StoreParamManagedPointer Instance = new();

	private StoreParamManagedPointer() : base(IR.StoreParamManagedPointer, TransformType.Manual | TransformType.Transform)
	{
	}
