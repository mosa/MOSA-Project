...
/// <summary>
/// Provides functions for reading and writing specific sized types of data (e.g. various sized integers or byte arrays). It also provides
/// functions for writing those types in a reserved endianness.
/// </summary>
public class DataBlock
{
	...
	// Future: Remove these pointless functions
