...
public sealed class Load64 : BaseIRTransform
{
	...
	public override void Transform(Context context, TransformContext transform)
	{
		...
		context.AppendInstruction(ARMv8A32.Ldr32, resultLow, v1, Operand.Constant32_0);
		context.AppendInstruction(ARMv8A32.Add, v2, v1, Operand.Constant32_4);
		context.AppendInstruction(ARMv8A32.Ldr32, resultHigh, v2, Operand.Constant32_0);
	}
}
