...
{
	/// <summary>
	/// AdcSShift32 - Add with Carry
	/// </summary>
	/// <seealso cref="Mosa.Platform.ARMv8A32.ARMv8A32Instruction" />
	public sealed class AdcSShift32 : ARMv8A32Instruction
	{
		public override int ID { get { return 576; } }

		internal AdcSShift32()
			: base(1, 4)
		{
		}
		...
		public override void Emit(InstructionNode node, BaseCodeEmitter emitter)
		{
			...
			if (node.Operand2.IsCPURegister && node.Operand3.IsConstant && node.GetOperand(3).IsConstant)
			{
