...
{
	/// <summary>
	/// StrImm32 - Single Data Transfer
	/// </summary>
	/// <seealso cref="Mosa.Platform.ARMv8A32.ARMv8A32Instruction" />
	public sealed class StrImm32 : ARMv8A32Instruction
	{
		...
		public override void Emit(InstructionNode node, BaseCodeEmitter emitter)
		{
			...
			if (node.Operand1.IsCPURegister && node.Operand2.IsConstant && node.Operand3.IsConstant && node.GetOperand(3).IsCPURegister)
			{
