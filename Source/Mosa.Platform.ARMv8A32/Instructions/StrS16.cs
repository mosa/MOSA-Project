...
namespace Mosa.Platform.ARMv8A32.Instructions
{
	...
	public sealed class StrS16 : ARMv8A32Instruction
	{
		...
		public override void Emit(InstructionNode node, BaseCodeEmitter emitter)
		{
			...
			if (node.Operand1.IsCPURegister && node.Operand2.IsCPURegister && node.Operand3.IsConstant && node.GetOperand(3).IsCPURegister)
			{
