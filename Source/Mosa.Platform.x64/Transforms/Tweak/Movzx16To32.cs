...
{
	public Movzx16To32() : base(X64.Movzx16To32, TransformType.Manual | TransformType.Transform)
	{
	}
	...
	public override void Transform(Context context, TransformContext transform)
	{
		...
		if (source.Register != result.Register)
		{
			...
			context.AppendInstruction(X64.And32, result, result, transform.CreateConstant32(0xFFFF));
		}
		else
		{
			context.SetInstruction(X64.And32, result, result, transform.CreateConstant32(0xFFFF));
		}
	}
}
