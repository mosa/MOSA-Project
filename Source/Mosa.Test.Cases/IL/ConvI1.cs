...
namespace Mosa.Test.Cases.IL
{
	...
	public class ConvI1 : TestCompilerAdapter
	{
		...
		public void ConvI1_I1(sbyte a)
		{
			...
			Assert.IsTrue(Run<bool>(string.Empty, "Test", "ConvI1_I1", a, a));
		}
		...
		public void ConvI1_I2(short a)
		{
			...
			Assert.IsTrue(Run<bool>(string.Empty, "Test", "ConvI1_I2", ((sbyte)a), a));
		}
		...
		public void ConvI1_I4(int a)
		{
			...
			Assert.IsTrue(Run<bool>(string.Empty, "Test", "ConvI1_I4", ((sbyte)a), a));
		}
		...
		public void ConvI1_I8(long a)
		{
			...
			Assert.IsTrue(Run<bool>(string.Empty, "Test", "ConvI1_I8", ((sbyte)a), a));
		}
		...
		public void ConvI1_R4(float a)
		{
			...
			Assert.IsTrue(Run<bool>(string.Empty, "Test", "ConvI1_R4", ((sbyte)a), a));
		}
		...
		public void ConvI1_R8(double a)
		{
			...
			Assert.IsTrue(Run<bool>(string.Empty, "Test", "ConvI1_R8", ((sbyte)a), a));
		}
	}
}
