...
public class BitTwiddlingTests
{
	...
	{
		Debug.Assert(BitTwiddling.GetBitsOver(0b11UL) == 0b1111111111111111111111111111111111111111111111111111111111111000UL);
		Debug.Assert(BitTwiddling.GetBitsOver(0b1111111111UL) == 0b1111111111111111111111111111111111111111111111111111100000000000UL);
		Debug.Assert(BitTwiddling.GetBitsOver(0b0UL) == 0b1111111111111111111111111111111111111111111111111111111111111110UL);
