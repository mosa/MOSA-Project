...
namespace System.Collections.Generic
{
		...
		IReadOnlyCollection<T>
	{
		...
		public void CopyTo(T[] array, int arrayIndex)
		{
			...
			{
				throw new ArgumentOutOfRangeException(nameof(arrayIndex), "Argument out of range for index");
			}
			...
			Collections.IEnumerator
		{
			...
			{
				if (_version != _q._version) throw new InvalidOperationException("Invalid operation, enumeration version failed");
