...
namespace Mosa.Tools.Compiler.Linker
{
	...
	/// 
	/// </summary>
	public class Elf64LinkerStage : BaseAssemblyLinkerStage, IPipelineStage
	{
		...
		/// 
		/// </summary>
		private Elf64NullSection nullSection;
		/// <summary>
		/// 
		/// </summary>
		private Elf64StringTableSection stringTableSection;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Elf64LinkerStage"/> class.
		/// </summary>
		public Elf64LinkerStage()
		{
		...
		{
			Elf64Section linkerSection = (Elf64Section)GetSection(section);
		...
		protected override void ApplyPatch(LinkType linkType, long methodAddress, long methodOffset, long methodRelativeBase, long targetAddress)
		{
			...
			Elf64Section text = (Elf64Section)GetSection(SectionKind.Text);
		...
		private void CreateElf64File(Mosa.Runtime.CompilerFramework.AssemblyCompiler compiler)
		{
			using (System.IO.FileStream fs = new System.IO.FileStream(this.OutputFile, System.IO.FileMode.Create, System.IO.FileAccess.Write, System.IO.FileShare.None))
			{
				...
				uint offset = 0;
				foreach (Elf64Section section in Sections)
				{
